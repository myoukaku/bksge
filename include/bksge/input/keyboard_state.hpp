...
#ifndef BKSGE_INPUT_KEYBOARD_STATE_HPP
#define BKSGE_INPUT_KEYBOARD_STATE_HPP

#include <bksge/input/key_code.hpp>
...
public:
	BKSGE_STATIC_CONSTEXPR auto kKeyCodeMax	=
		static_cast<std::size_t>(KeyCode::kMax);
...
#endif // BKSGE_INPUT_KEYBOARD_STATE_HPP
