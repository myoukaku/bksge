 ...
 *	@file	cblc.hpp
 *
 *	@brief	ColorBitmapLocationTable の定義
 *
 *	@author	myoukaku
 */

#ifndef BKSGE_CORE_FONT_OTF_CBLC_HPP
#define BKSGE_CORE_FONT_OTF_CBLC_HPP
...
struct ColorBitmapLocationTable
{
	...
	{
		friend bksge::uint8_t const*
		ReadBigEndian(bksge::uint8_t const* ptr, BitmapSize* dst)
		{
	...
	explicit ColorBitmapLocationTable(bksge::uint8_t const* ptr)
	{
		uint16	majorVersion;
		uint16	minorVersion;
		uint32	numSizes;
...
#endif // BKSGE_CORE_FONT_OTF_CBLC_HPP
