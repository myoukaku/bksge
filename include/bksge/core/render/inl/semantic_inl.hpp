...
{
#define BKSGE_CORE_RENDER_MAKE_SEMANTIC_KVP(x)	{ x, #x }

	static std::unordered_map<Semantic, std::string> const m =
	{
		BKSGE_CORE_RENDER_MAKE_SEMANTIC_KVP(Semantic::kPosition),
		BKSGE_CORE_RENDER_MAKE_SEMANTIC_KVP(Semantic::kNormal),
		BKSGE_CORE_RENDER_MAKE_SEMANTIC_KVP(Semantic::kColor),
		BKSGE_CORE_RENDER_MAKE_SEMANTIC_KVP(Semantic::kTexCoord),
		BKSGE_CORE_RENDER_MAKE_SEMANTIC_KVP(Semantic::kFogCoord),
		BKSGE_CORE_RENDER_MAKE_SEMANTIC_KVP(Semantic::kPointSize),
		BKSGE_CORE_RENDER_MAKE_SEMANTIC_KVP(Semantic::kBlendWeight),
		BKSGE_CORE_RENDER_MAKE_SEMANTIC_KVP(Semantic::kBlendIndices),
		BKSGE_CORE_RENDER_MAKE_SEMANTIC_KVP(Semantic::kTangent),
		BKSGE_CORE_RENDER_MAKE_SEMANTIC_KVP(Semantic::kBinormal),
	};
...
#undef BKSGE_CORE_RENDER_MAKE_SEMANTIC_KVP
}
