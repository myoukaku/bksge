...
#ifndef BKSGE_CORE_RENDER_GL_DETAIL_INL_GLEXT_INL_HPP
#define BKSGE_CORE_RENDER_GL_DETAIL_INL_GLEXT_INL_HPP
...
#endif // BKSGE_CORE_RENDER_GL_DETAIL_INL_GLEXT_INL_HPP
