...
using ID3D12DebugN               = ::ID3D12Debug2;
...
#elif defined(NTDDI_WIN10_RS3) && NTDDI_VERSION >= NTDDI_WIN10_RS3	// Windows 10 version 1709 (SDK 10.0.16299.0)
...
using ID3D12PipelineLibraryN     = ::ID3D12PipelineLibrary1;
using ID3D12ResourceN            = ::ID3D12Resource;
#elif defined(NTDDI_WIN10_RS2) && NTDDI_VERSION >= NTDDI_WIN10_RS2	// Windows 10 version 1703 (SDK 10.0.15063.0)
...
using ID3D12PipelineLibraryN     = ::ID3D12PipelineLibrary1;
using ID3D12ResourceN            = ::ID3D12Resource;
#elif defined(NTDDI_WIN10_RS1) && NTDDI_VERSION >= NTDDI_WIN10_RS1	// Windows 10 version 1607 (SDK 10.0.14393.0)
using ID3D12DeviceN              = ::ID3D12Device1;
using ID3D12DebugN               = ::ID3D12Debug;
using ID3D12FenceN               = ::ID3D12Fence;
