...
#ifndef BKSGE_CORE_RENDER_VULKAN_DETAIL_VULKAN_EXT_HPP
#define BKSGE_CORE_RENDER_VULKAN_DETAIL_VULKAN_EXT_HPP
...
#endif // BKSGE_CORE_RENDER_VULKAN_DETAIL_VULKAN_EXT_HPP
