...
#ifndef BKSGE_MATH_RECT_HPP
#define BKSGE_MATH_RECT_HPP

#include <bksge/math/fwd/rect_fwd.hpp>
#include <bksge/math/fwd/vector2_fwd.hpp>
#include <bksge/math/fwd/size2_fwd.hpp>
