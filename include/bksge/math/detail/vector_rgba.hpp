...
#ifndef BKSGE_MATH_DETAIL_VECTOR_RGBA_HPP
#define BKSGE_MATH_DETAIL_VECTOR_RGBA_HPP
...
public:
	...
	BKSGE_MATH_NAMED_ACCESS(r, 0);
	BKSGE_MATH_DECLARE_SWIZZLE_OPERATOR((r));
};
...
public:
	...
	BKSGE_MATH_NAMED_ACCESS(r, 0);
	BKSGE_MATH_NAMED_ACCESS(g, 1);
	BKSGE_MATH_DECLARE_SWIZZLE_OPERATOR((r)(g));
};
...
public:
	...
	BKSGE_MATH_NAMED_ACCESS(r, 0);
	BKSGE_MATH_NAMED_ACCESS(g, 1);
	BKSGE_MATH_NAMED_ACCESS(b, 2);
	BKSGE_MATH_DECLARE_SWIZZLE_OPERATOR((r)(g)(b));
};
...
public:
	...
	BKSGE_MATH_NAMED_ACCESS(g, 1);
	BKSGE_MATH_NAMED_ACCESS(b, 2);
	BKSGE_MATH_NAMED_ACCESS(a, 3);
	BKSGE_MATH_DECLARE_SWIZZLE_OPERATOR((r)(g)(b)(a));
};
...
#endif // BKSGE_MATH_DETAIL_VECTOR_RGBA_HPP
