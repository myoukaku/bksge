...
#ifndef BKSGE_MATH_DETAIL_VECTOR_WHD_HPP
#define BKSGE_MATH_DETAIL_VECTOR_WHD_HPP
...
public:
	...
	BKSGE_MATH_NAMED_ACCESS(w, 0);
	BKSGE_MATH_NAMED_ACCESS(width, 0);
	BKSGE_MATH_DECLARE_SWIZZLE_OPERATOR((w));
};
...
public:
	...
	BKSGE_MATH_NAMED_ACCESS(w, 0);
	BKSGE_MATH_NAMED_ACCESS(h, 1);
	BKSGE_MATH_NAMED_ACCESS(width,  0);
	BKSGE_MATH_NAMED_ACCESS(height, 1);
	BKSGE_MATH_DECLARE_SWIZZLE_OPERATOR((w)(h));
};
...
public:
	...
	BKSGE_MATH_NAMED_ACCESS(w, 0);
	BKSGE_MATH_NAMED_ACCESS(h, 1);
	BKSGE_MATH_NAMED_ACCESS(d, 2);
	BKSGE_MATH_NAMED_ACCESS(width,  0);
	BKSGE_MATH_NAMED_ACCESS(height, 1);
	BKSGE_MATH_NAMED_ACCESS(depth,  2);
	BKSGE_MATH_DECLARE_SWIZZLE_OPERATOR((w)(h)(d));
};
...
#endif // BKSGE_MATH_DETAIL_VECTOR_WHD_HPP
