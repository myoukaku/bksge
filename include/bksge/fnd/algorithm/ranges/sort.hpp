 ...
 *	@file	sort.hpp
 *
 *	@brief	ranges::sort の定義
 *
 *	@author	myoukaku
 */

#ifndef BKSGE_FND_ALGORITHM_RANGES_SORT_HPP
#define BKSGE_FND_ALGORITHM_RANGES_SORT_HPP
...
struct sort_fn
{
		...
		Comp comp = {}, Proj proj = {}) const
	{
		...
		bksge::sort(bksge::move(first), lasti,
...
BKSGE_INLINE_VAR BKSGE_CONSTEXPR sort_fn sort{};
...
#endif // BKSGE_FND_ALGORITHM_RANGES_SORT_HPP
