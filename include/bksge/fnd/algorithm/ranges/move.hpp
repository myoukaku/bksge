...
#ifndef BKSGE_FND_ALGORITHM_RANGES_MOVE_HPP
#define BKSGE_FND_ALGORITHM_RANGES_MOVE_HPP
...
private:
	template <
		...
		typename Out
	>
	static BKSGE_CXX14_CONSTEXPR move_result<Iter, Out>
...
#endif
		{
			if constexpr (__memcpyable<Iter, Out>::value)
			{
				...
				if (num)
				{
					__builtin_memmove(result, first, sizeof(ValueTypeI) * num);
				}
...
public:
	...
	>
#endif
	BKSGE_CXX14_CONSTEXPR move_result<Iter, Out>
...
BKSGE_INLINE_VAR BKSGE_CONSTEXPR move_fn move{};
...
#endif // BKSGE_FND_ALGORITHM_RANGES_MOVE_HPP
