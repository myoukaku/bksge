...
#ifndef BKSGE_FND_ALGORITHM_RANGES_MERGE_HPP
#define BKSGE_FND_ALGORITHM_RANGES_MERGE_HPP
...
struct merge_fn
{
	...
	>
#endif
	BKSGE_CXX14_CONSTEXPR merge_result<Iter1, Iter2, Out>
	operator()(
	...
	>
#endif
	BKSGE_CXX14_CONSTEXPR merge_result<
...
BKSGE_INLINE_VAR BKSGE_CONSTEXPR merge_fn merge{};
...
#endif // BKSGE_FND_ALGORITHM_RANGES_MERGE_HPP
