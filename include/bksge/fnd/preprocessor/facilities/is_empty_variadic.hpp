...
#ifndef BKSGE_FND_PREPROCESSOR_FACILITIES_IS_EMPTY_VARIADIC_HPP
#define BKSGE_FND_PREPROCESSOR_FACILITIES_IS_EMPTY_VARIADIC_HPP

# include <bksge/fnd/preprocessor/config/config.hpp>

# if BKSGE_PP_VARIADICS

# include <bksge/fnd/preprocessor/punctuation/is_begin_parens.hpp>
# include <bksge/fnd/preprocessor/facilities/detail/is_empty.hpp>
...
#endif // BKSGE_FND_PREPROCESSOR_FACILITIES_IS_EMPTY_VARIADIC_HPP
