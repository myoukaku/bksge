...
#if !(defined(BKSGE_MSVC_FULL_VER) && (192829910 <= BKSGE_MSVC_FULL_VER && BKSGE_MSVC_FULL_VER <= 192829914))
// Visual Studio 2019 version 16.9.(0-4) で <optional> をインクルードするとコンパイルエラーになる
#  include <optional>
#endif
#endif
