...
#ifndef BKSGE_FND_CMATH_INL_LOG1P_INL_HPP
#define BKSGE_FND_CMATH_INL_LOG1P_INL_HPP
...
log1p(ArithmeticType x) BKSGE_NOEXCEPT
{
	...
	return detail::log1p_impl(static_cast<type>(x));
}

}	// namespace bksge

#endif // BKSGE_FND_CMATH_INL_LOG1P_INL_HPP
