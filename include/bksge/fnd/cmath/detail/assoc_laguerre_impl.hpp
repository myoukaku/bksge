...
assoc_laguerre_impl(unsigned int n, unsigned int m, double x)
{
	return std::assoc_laguerre(n, m, x);
}

inline /*BKSGE_CONSTEXPR*/ float
assoc_laguerre_impl(unsigned int n, unsigned int m, float x)
{
	return std::assoc_laguerref(n, m, x);
}

inline /*BKSGE_CONSTEXPR*/ long double
assoc_laguerre_impl(unsigned int n, unsigned int m, long double x)
{
...
assoc_laguerre_impl(unsigned int n, unsigned int m, T x)
{
	...
	return static_cast<T>(assoc_laguerre_unchecked(n, m, static_cast<value_type>(x)));
}
