...
#ifndef BKSGE_FND_CONFIG_SUFFIX_CARRIES_DEPENDENCY_HPP
#define BKSGE_FND_CONFIG_SUFFIX_CARRIES_DEPENDENCY_HPP
...
#endif // BKSGE_FND_CONFIG_SUFFIX_CARRIES_DEPENDENCY_HPP
