...
#ifndef BKSGE_FND_CONFIG_COMPILER_APPLE_CLANG_HPP
#define BKSGE_FND_CONFIG_COMPILER_APPLE_CLANG_HPP
...
#define BKSGE_APPLE_CLANG_VERSION	BKSGE_CLANG_VERSION
#define BKSGE_APPLE_CLANG			BKSGE_CLANG

#define BKSGE_COMPILER_VERSION		BKSGE_CLANG_VERSION
#define BKSGE_COMPILER				"Apple Clang"
...
#  endif
#  if defined(__cpp_aligned_new) && (__cpp_aligned_new >= 201606) && (BKSGE_CLANG_VERSION >= 100000)
