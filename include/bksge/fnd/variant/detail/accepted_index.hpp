...
template <bksge::size_t Index, typename T, typename Ti, typename = void>
struct Build_FUN
{
...
template <bksge::size_t Index, typename T, typename Ti>
struct Build_FUN<Index, T, Ti, bksge::void_t<decltype(Arr<Ti>{ { bksge::declval<T>() }})>>
{
	...
	static bksge::integral_constant<bksge::size_t, Index> fun(Ti);
};
...
#if 0
template <typename T, typename... Ti, bksge::size_t... Indices>
...
#else
template <typename T, typename T0, typename... Ti, bksge::size_t I0, bksge::size_t... Indices>
...
template <typename T, typename T0, bksge::size_t I0>
...
struct accepted_index
	: public bksge::integral_constant<bksge::size_t, bksge::variant_npos>
{};
