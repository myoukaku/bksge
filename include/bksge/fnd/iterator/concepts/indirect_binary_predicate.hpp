...
private:
	...
	static auto test(int) -> bksge::conjunction<
		...
		bksge::predicate_t<F2&, bksge::iter_reference_t<J1>, bksge::iter_value_t<J2>&>,
		bksge::predicate_t<F2&, bksge::iter_reference_t<J1>, bksge::iter_reference_t<J2>>,
		bksge::predicate_t<F2&, bksge::iter_common_reference_t<J1>, bksge::iter_common_reference_t<J2>>
	>;
