...
private:
	...
	static auto test(int) -> bksge::conjunction<
		...
		bksge::strict_weak_order_t<F2&, bksge::iter_reference_t<J1>, bksge::iter_value_t<J2>&>,
		bksge::strict_weak_order_t<F2&, bksge::iter_reference_t<J1>, bksge::iter_reference_t<J2>>,
		bksge::strict_weak_order_t<F2&, bksge::iter_common_reference_t<J1>, bksge::iter_common_reference_t<J2>>
	>;
