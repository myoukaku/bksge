...
#ifndef BKSGE_UNITS_DETAIL_GET_DIMENSION_POWER_HPP
#define BKSGE_UNITS_DETAIL_GET_DIMENSION_POWER_HPP

#include <bksge/units/detail/derived_dimension_fwd.hpp>
#include <bksge/type_traits/is_same.hpp>
...
#endif // BKSGE_UNITS_DETAIL_GET_DIMENSION_POWER_HPP
