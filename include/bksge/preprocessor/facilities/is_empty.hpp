...
#ifndef BKSGE_PREPROCESSOR_FACILITIES_IS_EMPTY_HPP
#define BKSGE_PREPROCESSOR_FACILITIES_IS_EMPTY_HPP
#
# include <bksge/preprocessor/config/config.hpp>
#
# if BKSGE_PP_VARIADICS
#
# include <bksge/preprocessor/facilities/is_empty_variadic.hpp>
#
# else
#
# if ~BKSGE_PP_CONFIG_FLAGS() & BKSGE_PP_CONFIG_MSVC() && ~BKSGE_PP_CONFIG_FLAGS() & BKSGE_PP_CONFIG_MWCC()
# include <bksge/preprocessor/tuple/elem.hpp>
# include <bksge/preprocessor/facilities/identity.hpp>
# else
# include <bksge/preprocessor/cat.hpp>
# include <bksge/preprocessor/detail/split.hpp>
# endif
#
# /* BKSGE_PP_IS_EMPTY */
#
...
#
#endif // BKSGE_PREPROCESSOR_FACILITIES_IS_EMPTY_HPP
