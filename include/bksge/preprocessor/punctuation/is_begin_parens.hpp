...
#ifndef BKSGE_PREPROCESSOR_PUNCTUATION_IS_BEGIN_PARENS_HPP
#define BKSGE_PREPROCESSOR_PUNCTUATION_IS_BEGIN_PARENS_HPP

# include <bksge/preprocessor/config/config.hpp>

#if BKSGE_PP_VARIADICS

#include <bksge/preprocessor/punctuation/detail/is_begin_parens.hpp>
...
#endif // BKSGE_PREPROCESSOR_PUNCTUATION_IS_BEGIN_PARENS_HPP
