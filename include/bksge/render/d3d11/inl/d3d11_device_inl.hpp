/**
 *	@file	d3d11_device_inl.hpp
 *
 *	@brief	D3D11Device の実装
 *
 *	@author	myoukaku
 */

#ifndef BKSGE_RENDER_D3D11_INL_D3D11_DEVICE_INL_HPP
#define BKSGE_RENDER_D3D11_INL_D3D11_DEVICE_INL_HPP
...
BKSGE_INLINE
D3D11Device::D3D11Device(std::vector<ComPtr<::IDXGIAdapter1>> const& adapters)
{
...
D3D11Device::GetImmediateContext(void)
{
...
D3D11Device::CreateSamplerState(::D3D11_SAMPLER_DESC const& desc)
{
...
D3D11Device::CreateVertexShader(::ID3DBlob* micro_code)
{
...
D3D11Device::CreatePixelShader(::ID3DBlob* micro_code)
{
...
#endif // BKSGE_RENDER_D3D11_INL_D3D11_DEVICE_INL_HPP
