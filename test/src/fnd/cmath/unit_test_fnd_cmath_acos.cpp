...
static_assert(bksge::is_same<float,       decltype(bksge::acos(0.0f))>::value, "");
static_assert(bksge::is_same<float,       decltype(bksge::acosf(0.0f))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::acos(0.0 ))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::acos(0   ))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::acos(0.0l))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::acosl(0.0l))>::value, "");
