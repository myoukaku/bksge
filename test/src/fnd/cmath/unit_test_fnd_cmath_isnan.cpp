/**
 *	@file	unit_test_fnd_cmath_isnan.cpp
 *
 *	@brief	isnan のテスト
 *
 *	@author	myoukaku
...
static_assert(bksge::is_same<bool, decltype(bksge::isnan(0.0f))>::value, "");
static_assert(bksge::is_same<bool, decltype(bksge::isnan(0.0 ))>::value, "");
static_assert(bksge::is_same<bool, decltype(bksge::isnan(0.0l))>::value, "");
static_assert(bksge::is_same<bool, decltype(bksge::isnan(0   ))>::value, "");
