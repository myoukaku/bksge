...
GTEST_TEST(CStringTest, CStringTest)
{
	...
	const char* cpc = 0;
	char ca[32] = {};
	static_assert((bksge::is_same<decltype(bksge::strcpy(cp, cpc)), char*>::value), "");
	static_assert((bksge::is_same<decltype(bksge::strcpy(ca, cpc)), char*>::value), "");
	static_assert((bksge::is_same<decltype(bksge::strncpy(cp, cpc, s)), char*>::value), "");
	static_assert((bksge::is_same<decltype(bksge::strcat(cp, cpc)), char*>::value), "");
	static_assert((bksge::is_same<decltype(bksge::strcat(ca, cpc)), char*>::value), "");
	static_assert((bksge::is_same<decltype(bksge::strncat(cp, cpc, s)), char*>::value), "");
...
//	static_assert((bksge::is_same<decltype(bksge::memchr(vpc, 0, s)), const void*>::value), "");
	...
	static_assert((bksge::is_same<decltype(bksge::memcpy(vp, vpc, s)), void*>::value), "");
