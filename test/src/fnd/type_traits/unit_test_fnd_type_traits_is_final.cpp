...
GTEST_TEST(TypeTraitsTest, IsFinalTest)
{
#if BKSGE_CXX_STANDARD >= 14

	IntegralConstantTest<bksge::is_final<int>, false>();
	IntegralConstantTest<bksge::is_final<final_UDT>,			true>();
	IntegralConstantTest<bksge::is_final<final_Derived_UDT>,	true>();
	IntegralConstantTest<bksge::is_final<final_union_UDT>,		true>();
