...
GTEST_TEST(TypeTraitsTest, IsTriviallyCopyConstructibleTest)
{
	IntegralConstantTest<bksge::is_trivially_copy_constructible<S1>, true>();
	IntegralConstantTest<bksge::is_trivially_copy_constructible<S2>, false>();
	IntegralConstantTest<bksge::is_trivially_copy_constructible<S3>, false>();
	IntegralConstantTest<bksge::is_trivially_copy_constructible<S4>, false>();
	IntegralConstantTest<bksge::is_trivially_copy_constructible<S5>, false>();
	IntegralConstantTest<bksge::is_trivially_copy_constructible<S6>, false>();
