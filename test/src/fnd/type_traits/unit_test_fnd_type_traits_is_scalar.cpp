...
GTEST_TEST(TypeTraitsTest, IsScalarTest)
{
	IntegralConstantTest<bksge::is_scalar<int>, true>();
	IntegralConstantTest<bksge::is_scalar<UDT>, false>();
	...
	BKSGE_IS_SCALAR_TEST(true,  bksge::size_t);
