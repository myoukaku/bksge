...
GTEST_TEST(TypeTraitsTest, IsMemberPointerTest)
{
	IntegralConstantTest<bksge::is_member_pointer<f1>, false>();
	IntegralConstantTest<bksge::is_member_pointer<mf1>, true>();
	IntegralConstantTest<bksge::is_member_pointer<mp>, true>();
	IntegralConstantTest<bksge::is_member_pointer<foo0_t>, false>();
