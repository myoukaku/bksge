...
GTEST_TEST(TypeTraitsTest, IsTrivialTest)
{
	IntegralConstantTest<bksge::is_trivial<UDT>, false>();
	IntegralConstantTest<bksge::is_trivial<POD_UDT>, true>();
	...
	BKSGE_IS_TRIVIAL_TEST(true, std::nullptr_t);
