...
GTEST_TEST(TypeTraitsTest, IsTriviallyCopyableTest)
{
	IntegralConstantTest<bksge::is_trivially_copyable<UDT>, false>();
	IntegralConstantTest<bksge::is_trivially_copyable<POD_UDT>, true>();
