...
GTEST_TEST(TypeTraitsTest, IsLvalueReferenceTest)
{
	IntegralConstantTest<bksge::is_lvalue_reference<int>, false>();
	IntegralConstantTest<bksge::is_lvalue_reference<int&>, true>();
	IntegralConstantTest<bksge::is_lvalue_reference<int&&>, false>();
