...
GTEST_TEST(TypeTraitsTest, IsNothrowConstructibleTest)
{
#define BKSGE_IS_NOTHROW_CONSTRUCTIBLE_TEST_RT(b, ...)	\
		IntegralConstantTest<bksge::is_nothrow_constructible<__VA_ARGS__>, b>()

	BKSGE_IS_NOTHROW_CONSTRUCTIBLE_TEST_RT(true,  int);
	BKSGE_IS_NOTHROW_CONSTRUCTIBLE_TEST_RT(true,  int, int);
	BKSGE_IS_NOTHROW_CONSTRUCTIBLE_TEST_RT(false, int, int, int);
	BKSGE_IS_NOTHROW_CONSTRUCTIBLE_TEST_RT(false, int, std::string);
	BKSGE_IS_NOTHROW_CONSTRUCTIBLE_TEST_RT(false, int&, int);

	BKSGE_IS_NOTHROW_CONSTRUCTIBLE_TEST_RT(false, trivial_except_construct);
	BKSGE_IS_NOTHROW_CONSTRUCTIBLE_TEST_RT(true,  trivial_except_destroy);
	BKSGE_IS_NOTHROW_CONSTRUCTIBLE_TEST_RT(false, trivial_except_copy_ctor);
	BKSGE_IS_NOTHROW_CONSTRUCTIBLE_TEST_RT(true,  trivial_except_copy_assign);
	BKSGE_IS_NOTHROW_CONSTRUCTIBLE_TEST_RT(false, trivial_except_move_ctor);
	BKSGE_IS_NOTHROW_CONSTRUCTIBLE_TEST_RT(true,  trivial_except_move_assign);
	BKSGE_IS_NOTHROW_CONSTRUCTIBLE_TEST_RT(true,  trivial_except_construct,		trivial_except_construct);
	BKSGE_IS_NOTHROW_CONSTRUCTIBLE_TEST_RT(true,  trivial_except_destroy,		trivial_except_destroy);
	BKSGE_IS_NOTHROW_CONSTRUCTIBLE_TEST_RT(false, trivial_except_copy_ctor,		trivial_except_copy_ctor);
	BKSGE_IS_NOTHROW_CONSTRUCTIBLE_TEST_RT(true,  trivial_except_copy_assign,	trivial_except_copy_assign);
	BKSGE_IS_NOTHROW_CONSTRUCTIBLE_TEST_RT(false, trivial_except_move_ctor,		trivial_except_move_ctor);
	BKSGE_IS_NOTHROW_CONSTRUCTIBLE_TEST_RT(false, trivial_except_move_assign,	trivial_except_move_assign);

#undef BKSGE_IS_NOTHROW_CONSTRUCTIBLE_TEST_RT
