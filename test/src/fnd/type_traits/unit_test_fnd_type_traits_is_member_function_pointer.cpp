...
GTEST_TEST(TypeTraitsTest, IsMemberFunctionPointerTest)
{
	IntegralConstantTest<bksge::is_member_function_pointer<f1>,     false>();
	IntegralConstantTest<bksge::is_member_function_pointer<mf1>,    true>();
	IntegralConstantTest<bksge::is_member_function_pointer<mp>,     false>();
	IntegralConstantTest<bksge::is_member_function_pointer<foo0_t>, false>();
