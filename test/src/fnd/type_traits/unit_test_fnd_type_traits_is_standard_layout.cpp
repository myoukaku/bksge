...
GTEST_TEST(TypeTraitsTest, IsStandardLayoutTest)
{
	IntegralConstantTest<bksge::is_standard_layout<UDT>, true>();
	IntegralConstantTest<bksge::is_standard_layout<polymorphic_base>, false>();
