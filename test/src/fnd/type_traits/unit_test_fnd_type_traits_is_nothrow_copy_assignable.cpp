...
GTEST_TEST(TypeTraitsTest, IsNothrowCopyAssignableTest)
{
	IntegralConstantTest<bksge::is_nothrow_copy_assignable<S1>, true>();
	IntegralConstantTest<bksge::is_nothrow_copy_assignable<S2>, true>();
	IntegralConstantTest<bksge::is_nothrow_copy_assignable<S3>, true>();
	IntegralConstantTest<bksge::is_nothrow_copy_assignable<S4>, false>();
	IntegralConstantTest<bksge::is_nothrow_copy_assignable<S5>, false>();
	IntegralConstantTest<bksge::is_nothrow_copy_assignable<S6>, false>();
