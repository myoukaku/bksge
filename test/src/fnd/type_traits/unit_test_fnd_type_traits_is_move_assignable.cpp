...
GTEST_TEST(TypeTraitsTest, IsMoveAssignableTest)
{
	IntegralConstantTest<bksge::is_move_assignable<S1>, true>();
	IntegralConstantTest<bksge::is_move_assignable<S2>, true>();
	IntegralConstantTest<bksge::is_move_assignable<S3>, true>();
	IntegralConstantTest<bksge::is_move_assignable<S4>, true>();
	IntegralConstantTest<bksge::is_move_assignable<S5>, true>();
	IntegralConstantTest<bksge::is_move_assignable<S6>, false>();
