...
GTEST_TEST(TypeTraitsTest, IsArithmeticTest)
{
	IntegralConstantTest<bksge::is_arithmetic<int>, true>();
	IntegralConstantTest<bksge::is_arithmetic<UDT>, false>();
	...
	BKSGE_IS_ARITHMETIC_TEST(true, bksge::size_t);
