...
GTEST_TEST(TypeTraitsTest, IsFloatingPointTest)
{
	IntegralConstantTest<bksge::is_floating_point<int>, false>();
	IntegralConstantTest<bksge::is_floating_point<float>, true>();
