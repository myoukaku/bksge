...
GTEST_TEST(TypeTraitsTest, IsClassTest)
{
	IntegralConstantTest<bksge::is_class<int>, false>();
	IntegralConstantTest<bksge::is_class<enum_UDT>, false>();
	IntegralConstantTest<bksge::is_class<UDT>, true>();
