...
GTEST_TEST(TypeTraitsTest, IsTriviallyAssignableTest)
{
	IntegralConstantTest<bksge::is_trivially_assignable<S1, S1>, true>();
	IntegralConstantTest<bksge::is_trivially_assignable<S2, S2>, false>();
