...
GTEST_TEST(TypeTraitsTest, IsTriviallyCopyAssignableTest)
{
	IntegralConstantTest<bksge::is_trivially_copy_assignable<S1>, true>();
	IntegralConstantTest<bksge::is_trivially_copy_assignable<S2>, false>();
	IntegralConstantTest<bksge::is_trivially_copy_assignable<S3>, false>();
	IntegralConstantTest<bksge::is_trivially_copy_assignable<S4>, false>();
	IntegralConstantTest<bksge::is_trivially_copy_assignable<S5>, false>();
	IntegralConstantTest<bksge::is_trivially_copy_assignable<S6>, false>();
