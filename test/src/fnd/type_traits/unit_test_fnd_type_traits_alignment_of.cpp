...
GTEST_TEST(TypeTraitsTest, AlignmentOfTest)
{
	IntegralConstantTest<bksge::alignment_of<int>, sizeof(int)>();
	IntegralConstantTest<bksge::alignment_of<char>, sizeof(char)>();
