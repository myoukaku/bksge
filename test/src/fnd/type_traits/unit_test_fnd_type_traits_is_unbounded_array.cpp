...
GTEST_TEST(TypeTraitsTest, IsUnboundedArrayTest)
{
	IntegralConstantTest<bksge::is_unbounded_array<int>,       false>();
	IntegralConstantTest<bksge::is_unbounded_array<int[]>,     true>();
	IntegralConstantTest<bksge::is_unbounded_array<int[2]>,    false>();
	IntegralConstantTest<bksge::is_unbounded_array<int[3][4]>, false>();
	IntegralConstantTest<bksge::is_unbounded_array<int[][4]>,  true>();
