...
GTEST_TEST(TypeTraitsTest, IsNothrowMoveConstructibleTest)
{
	IntegralConstantTest<bksge::is_nothrow_move_constructible<S1>, true>();
	IntegralConstantTest<bksge::is_nothrow_move_constructible<S2>, true>();
	IntegralConstantTest<bksge::is_nothrow_move_constructible<S3>, true>();
	IntegralConstantTest<bksge::is_nothrow_move_constructible<S4>, false>();
	IntegralConstantTest<bksge::is_nothrow_move_constructible<S5>, false>();
	IntegralConstantTest<bksge::is_nothrow_move_constructible<S6>, false>();
