...
GTEST_TEST(TypeTraitsTest, IsLiteralTypeTest)
{
	IntegralConstantTest<bksge::is_literal_type<int>, true>();
	IntegralConstantTest<bksge::is_literal_type<UDT>, false>();
	...
	BKSGE_IS_LITERAL_TYPE_TEST(true, bksge::size_t);
	...
	BKSGE_IS_LITERAL_TYPE_TEST(true, void*);
	BKSGE_IS_LITERAL_TYPE_TEST(true, bksge::nullptr_t);
