...
GTEST_TEST(TypeTraitsTest, IsNothrowAssignableTest)
{
	IntegralConstantTest<bksge::is_nothrow_assignable<S1, S1>, false>();
	IntegralConstantTest<bksge::is_nothrow_assignable<S2, S2>, true>();
