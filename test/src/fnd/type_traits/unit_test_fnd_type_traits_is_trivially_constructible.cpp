...
GTEST_TEST(TypeTraitsTest, IsTriviallyConstructibleTest)
{
#if !(defined(BKSGE_GCC_VERSION) && (BKSGE_GCC_VERSION == 80100))	// gcc 8.1.0ではis_trivially_constructibleが正しくない

	IntegralConstantTest<bksge::is_trivially_constructible<int>, true>();
	IntegralConstantTest<bksge::is_trivially_constructible<int, int>, true>();
	IntegralConstantTest<bksge::is_trivially_constructible<int, int, int>, false>();
	IntegralConstantTest<bksge::is_trivially_constructible<int, std::string>, false>();
	IntegralConstantTest<bksge::is_trivially_constructible<int&, int>, false>();

	IntegralConstantTest<bksge::is_trivially_constructible<trivial_except_construct>,	false>();
	IntegralConstantTest<bksge::is_trivially_constructible<trivial_except_destroy>,		false>();
	IntegralConstantTest<bksge::is_trivially_constructible<trivial_except_copy_ctor>,	false>();
	IntegralConstantTest<bksge::is_trivially_constructible<trivial_except_copy_assign>,	true>();
	IntegralConstantTest<bksge::is_trivially_constructible<trivial_except_move_ctor>,	false>();
	IntegralConstantTest<bksge::is_trivially_constructible<trivial_except_move_assign>,	true>();
	IntegralConstantTest<bksge::is_trivially_constructible<trivial_except_construct,	trivial_except_construct>,		true>();
	IntegralConstantTest<bksge::is_trivially_constructible<trivial_except_destroy,		trivial_except_destroy>,		false>();
	IntegralConstantTest<bksge::is_trivially_constructible<trivial_except_copy_ctor,	trivial_except_copy_ctor>,		false>();
	IntegralConstantTest<bksge::is_trivially_constructible<trivial_except_copy_assign,	trivial_except_copy_assign>,	true>();
	IntegralConstantTest<bksge::is_trivially_constructible<trivial_except_move_ctor,	trivial_except_move_ctor>,		false>();
	IntegralConstantTest<bksge::is_trivially_constructible<trivial_except_move_assign,	trivial_except_move_assign>,	false>();
