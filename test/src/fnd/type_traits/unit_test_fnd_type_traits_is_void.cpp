...
GTEST_TEST(TypeTraitsTest, IsVoidTest)
{
	IntegralConstantTest<bksge::is_void<void>, true>();
	IntegralConstantTest<bksge::is_void<void*>, false>();
	...
	BKSGE_IS_VOID_TEST(false, std::size_t);
	...
	BKSGE_IS_VOID_TEST(false, std::nullptr_t);
