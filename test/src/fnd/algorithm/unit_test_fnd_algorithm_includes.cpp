...
{
	{
		...
		BKSGE_STATIC_CONSTEXPR bksge::array<int, 3> c  {{1,2,4}};
		BKSGE_STATIC_CONSTEXPR int                  d[] {2,4,6};
		BKSGE_STATIC_CONSTEXPR bksge::array<int, 3> e  {{3,5,7}};
	...
	{
		BKSGE_STATIC_CONSTEXPR bksge::array<int, 5> a  {{10,20,30,40,50}};
		BKSGE_STATIC_CONSTEXPR bksge::array<int, 5> b  {{10,20,30,40,50}};
		BKSGE_STATIC_CONSTEXPR int                  c[] {10,15,20};
		BKSGE_STATIC_CONSTEXPR bksge::array<int, 2> d  {{ 9,10}};
	...
	}
	{
		...
		const int                  b[] {9,7,5};
		const bksge::array<int, 3> c {{10,9,8}};
	...
	}
	{
		...
		const bksge::array<int, 3> c  {{91,90,88}};
