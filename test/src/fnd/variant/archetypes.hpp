...
BKSGE_WARNING_PUSH();
BKSGE_WARNING_DISABLE_GCC("-Wextra");
...
protected:
	...
	BKSGE_CXX14_CONSTEXPR ValueBase& operator=(ValueBase const& o) noexcept
	{
		assert(o.value != -1); assert(o.value != -999);
		value = o.value;
		return *this;
	...
	BKSGE_CXX14_CONSTEXPR ValueBase& operator=(ValueBase&& o) noexcept
	{
		assert(o.value != -1); assert(o.value != -999);
		value = o.value;
		o.value = -1;
...
{
#define DEFINE_CONSTEXPR
#define DEFINE_BASE(Name) bksge_variant_test::ArchetypeBases::TestBase<Name>
#include "archetypes.ipp"
...
#define DEFINE_CONSTEXPR
#define DEFINE_EXPLICIT explicit
#define DEFINE_BASE(Name) bksge_variant_test::ArchetypeBases::TestBase<Name, true>
#include "archetypes.ipp"
...
{
#define DEFINE_BASE(Name) bksge_variant_test::ArchetypeBases::ValueBase<>
#include "archetypes.ipp"
...
{
#define DEFINE_EXPLICIT explicit
#define DEFINE_BASE(Name) bksge_variant_test::ArchetypeBases::ValueBase<true>
#include "archetypes.ipp"
...
{
#define DEFINE_BASE(Name) bksge_variant_test::ArchetypeBases::TrivialValueBase<false>
#include "archetypes.ipp"
...
{
#define DEFINE_EXPLICIT explicit
#define DEFINE_BASE(Name) bksge_variant_test::ArchetypeBases::TrivialValueBase<true>
#include "archetypes.ipp"
...
#endif // UNIT_TEST_FND_VARIANT_ARCHETYPES_HPP
