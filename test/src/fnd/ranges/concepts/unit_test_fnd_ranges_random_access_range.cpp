...
BKSGE_RANGES_RANDOM_ACCESS_RANGE_TEST(true,  std::array<int, 2>);
BKSGE_RANGES_RANDOM_ACCESS_RANGE_TEST(true,  std::vector<int>);
BKSGE_RANGES_RANDOM_ACCESS_RANGE_TEST(true,  std::deque<int>);
BKSGE_RANGES_RANDOM_ACCESS_RANGE_TEST(false, std::list<int>);
...
BKSGE_RANGES_RANDOM_ACCESS_RANGE_TEST(true,  std::string);
