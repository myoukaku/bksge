...
BKSGE_RANGES_COMMON_RANGE_TEST(true,  std::vector<int>);
BKSGE_RANGES_COMMON_RANGE_TEST(true,  std::deque<int>);
BKSGE_RANGES_COMMON_RANGE_TEST(true,  std::list<int>);
BKSGE_RANGES_COMMON_RANGE_TEST(true,  std::forward_list<int>);
...
BKSGE_RANGES_COMMON_RANGE_TEST(true,  std::string);
