...
BKSGE_RANGES_SIZED_RANGE_TEST(true,  std::vector<int>);
BKSGE_RANGES_SIZED_RANGE_TEST(true,  std::deque<int>);
BKSGE_RANGES_SIZED_RANGE_TEST(true,  std::list<int>);
BKSGE_RANGES_SIZED_RANGE_TEST(false, std::forward_list<int>);
