/**
 *	@file	unit_test_fnd_config_cxx11.cpp
 *
 *	@brief	
 *
 *	@author	myoukaku
...
BKSGE_WARNING_PUSH()
BKSGE_WARNING_DISABLE_MSVC(4101)	// ローカル変数は 1 度も使われていません。
BKSGE_WARNING_DISABLE_MSVC(4189)	// ローカル変数が初期化されましたが、参照されていません
BKSGE_WARNING_DISABLE_CLANG("-Wunused-variable")
BKSGE_WARNING_DISABLE_GCC("-Wunused-variable")

namespace bksge_config_cxx11_test
{
