/**
 *	@file	unit_test_fnd_list_erase_if.cpp
 *
 *	@brief	erase_if のテスト
 *
 *	@author	myoukaku
...
EraseIfTest()
{
	...
	{
		bksge::list<int> v = {3,1,4,1,5,9,2,6,5,3,5,};
...
GTEST_TEST(ListTest, EraseIfTest)
{
