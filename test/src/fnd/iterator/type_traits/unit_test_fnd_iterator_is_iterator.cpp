...
GTEST_TEST(IteratorTest, IsIteratorTest)
{
	...
	static_assert(bksge::is_iterator<bksge::list<float>::iterator>::value                   == true, "");
	static_assert(bksge::is_iterator<bksge::list<float>::const_iterator>::value             == true, "");
	static_assert(bksge::is_iterator<bksge::list<float>::reverse_iterator>::value           == true, "");
	static_assert(bksge::is_iterator<bksge::list<float>::const_reverse_iterator>::value     == true, "");
