...
GTEST_TEST(IteratorTest, IsRandomAccessIteratorTest)
{
	...
	static_assert(bksge::is_random_access_iterator<bksge::list<float>::iterator>::value                   == false, "");
	static_assert(bksge::is_random_access_iterator<bksge::list<float>::const_iterator>::value             == false, "");
	static_assert(bksge::is_random_access_iterator<bksge::list<float>::reverse_iterator>::value           == false, "");
	static_assert(bksge::is_random_access_iterator<bksge::list<float>::const_reverse_iterator>::value     == false, "");
