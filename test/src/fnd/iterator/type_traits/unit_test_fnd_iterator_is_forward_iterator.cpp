...
GTEST_TEST(IteratorTest, IsForwardIteratorTest)
{
	...
	static_assert(bksge::is_forward_iterator<bksge::vector<int>::iterator>::value                   == true, "");
	static_assert(bksge::is_forward_iterator<bksge::vector<int>::const_iterator>::value             == true, "");
	static_assert(bksge::is_forward_iterator<bksge::vector<int>::reverse_iterator>::value           == true, "");
	static_assert(bksge::is_forward_iterator<bksge::vector<int>::const_reverse_iterator>::value     == true, "");
	...
	static_assert(bksge::is_forward_iterator<bksge::list<float>::iterator>::value                   == true, "");
	static_assert(bksge::is_forward_iterator<bksge::list<float>::const_iterator>::value             == true, "");
	static_assert(bksge::is_forward_iterator<bksge::list<float>::reverse_iterator>::value           == true, "");
	static_assert(bksge::is_forward_iterator<bksge::list<float>::const_reverse_iterator>::value     == true, "");
	...
	static_assert(bksge::is_forward_iterator<std::back_insert_iterator<bksge::vector<int>>>::value  == false, "");
	static_assert(bksge::is_forward_iterator<std::front_insert_iterator<bksge::vector<int>>>::value == false, "");
	static_assert(bksge::is_forward_iterator<std::insert_iterator<bksge::vector<int>>>::value       == false, "");
