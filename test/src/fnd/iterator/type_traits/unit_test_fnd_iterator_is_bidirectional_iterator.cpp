...
GTEST_TEST(IteratorTest, IsBidirectionalIteratorTest)
{
	...
	static_assert(bksge::is_bidirectional_iterator<bksge::vector<int>::iterator>::value                   == true, "");
	static_assert(bksge::is_bidirectional_iterator<bksge::vector<int>::const_iterator>::value             == true, "");
	static_assert(bksge::is_bidirectional_iterator<bksge::vector<int>::reverse_iterator>::value           == true, "");
	static_assert(bksge::is_bidirectional_iterator<bksge::vector<int>::const_reverse_iterator>::value     == true, "");
	...
	static_assert(bksge::is_bidirectional_iterator<std::list<float>::iterator>::value                   == true, "");
	static_assert(bksge::is_bidirectional_iterator<std::list<float>::const_iterator>::value             == true, "");
	static_assert(bksge::is_bidirectional_iterator<std::list<float>::reverse_iterator>::value           == true, "");
	static_assert(bksge::is_bidirectional_iterator<std::list<float>::const_reverse_iterator>::value     == true, "");
	...
	static_assert(bksge::is_bidirectional_iterator<std::back_insert_iterator<bksge::vector<int>>>::value  == false, "");
	static_assert(bksge::is_bidirectional_iterator<std::front_insert_iterator<bksge::vector<int>>>::value == false, "");
	static_assert(bksge::is_bidirectional_iterator<std::insert_iterator<bksge::vector<int>>>::value       == false, "");
