...
BKSGE_INPUT_ITERATOR_TEST(true,  bksge::array<int, 1>::iterator);
BKSGE_INPUT_ITERATOR_TEST(true,  bksge::array<A, 1>::const_iterator);
...
BKSGE_INPUT_ITERATOR_TEST(true,  bksge::istreambuf_iterator<char>);
BKSGE_INPUT_ITERATOR_TEST(false, bksge::ostreambuf_iterator<char>);
