...
BKSGE_BIDIRECTIONAL_ITERATOR_TEST(true,  bksge::array<int, 1>::iterator);
BKSGE_BIDIRECTIONAL_ITERATOR_TEST(true,  bksge::array<A, 1>::const_iterator);
BKSGE_BIDIRECTIONAL_ITERATOR_TEST(true,  bksge::deque<int>::iterator);
BKSGE_BIDIRECTIONAL_ITERATOR_TEST(true,  bksge::deque<A>::const_iterator);
