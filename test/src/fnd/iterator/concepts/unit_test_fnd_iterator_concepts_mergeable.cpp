...
BKSGE_MERGEABLE_TEST(true,  std::list<int>::iterator, std::array<int, 2>::iterator, bksge::vector<int>::iterator);
BKSGE_MERGEABLE_TEST(false, std::list<int>::iterator, std::array<int, 2>::iterator, bksge::vector<int>::const_iterator);
