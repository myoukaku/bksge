...
BKSGE_MERGEABLE_TEST(true,  bksge::list<int>::iterator, std::array<int, 2>::iterator, bksge::vector<int>::iterator);
BKSGE_MERGEABLE_TEST(false, bksge::list<int>::iterator, std::array<int, 2>::iterator, bksge::vector<int>::const_iterator);
BKSGE_MERGEABLE_TEST(true,  bksge::list<int>::iterator, std::array<int, 2>::iterator, bksge::list<int>::iterator);
BKSGE_MERGEABLE_TEST(false, bksge::list<int>::iterator, std::array<int, 2>::iterator, bksge::list<int>::const_iterator);
