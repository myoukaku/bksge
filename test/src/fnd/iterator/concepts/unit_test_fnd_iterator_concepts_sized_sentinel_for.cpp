...
BKSGE_SIZED_SENTINEL_FOR_TEST(false, int*,                               bksge::vector<int>::iterator);
BKSGE_SIZED_SENTINEL_FOR_TEST(true,  bksge::vector<int>::iterator,       bksge::vector<int>::iterator);
BKSGE_SIZED_SENTINEL_FOR_TEST(false, int*,                               bksge::vector<int>::const_iterator);
BKSGE_SIZED_SENTINEL_FOR_TEST(true,  bksge::vector<int>::const_iterator, bksge::vector<int>::const_iterator);
BKSGE_SIZED_SENTINEL_FOR_TEST(false, int*,                               bksge::istream_iterator<int>);
BKSGE_SIZED_SENTINEL_FOR_TEST(false, bksge::istream_iterator<int>,       bksge::istream_iterator<int>);
BKSGE_SIZED_SENTINEL_FOR_TEST(false, int*,                               bksge::ostream_iterator<int>);
BKSGE_SIZED_SENTINEL_FOR_TEST(false, bksge::ostream_iterator<int>,       bksge::ostream_iterator<int>);
