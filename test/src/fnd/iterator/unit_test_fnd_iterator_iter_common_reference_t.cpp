...
static_assert(bksge::is_same<bksge::iter_common_reference_t<bksge::list<double>::iterator>, double&>::value, "");
static_assert(bksge::is_same<bksge::iter_common_reference_t<bksge::list<double>::const_iterator>, double const&>::value, "");
