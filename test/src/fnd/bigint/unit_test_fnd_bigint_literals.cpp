...
GTEST_TEST(BigIntTest, LiteralsTest)
{
	...
	{
		constexpr auto x = bksge::numeric_limits<bksge::int512_t>::max();
	...
	{
		constexpr auto x = bksge::numeric_limits<bksge::int1024_t>::min();
	...
	{
		constexpr auto x = bksge::numeric_limits<bksge::int1024_t>::max();
	...
	{
		constexpr auto x = bksge::numeric_limits<bksge::int2048_t>::min();
	...
	{
		constexpr auto x = bksge::numeric_limits<bksge::int2048_t>::max();
	...
	{
		constexpr auto x = bksge::numeric_limits<bksge::uint512_t>::max();
	...
	{
		constexpr auto x = bksge::numeric_limits<bksge::uint1024_t>::min();
	...
	{
		constexpr auto x = bksge::numeric_limits<bksge::uint1024_t>::max();
	...
	{
		constexpr auto x = bksge::numeric_limits<bksge::uint2048_t>::min();
	...
	{
		constexpr auto x = bksge::numeric_limits<bksge::uint2048_t>::max();
