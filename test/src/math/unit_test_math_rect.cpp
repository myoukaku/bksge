...
TYPED_TEST(MathRectTest, Vector2Vector2ConstructTest)
{
	...
	{
		BKSGE_CONSTEXPR_OR_CONST Rect r(Vector2{1, 2}, Vector2{-3, -4});
		BKSGE_CONSTEXPR_EXPECT_EQ(-3, r.left());
		BKSGE_CONSTEXPR_EXPECT_EQ(-4, r.top());
		BKSGE_CONSTEXPR_EXPECT_EQ( 1, r.right());
		BKSGE_CONSTEXPR_EXPECT_EQ( 2, r.bottom());
	}
	{
		BKSGE_CONSTEXPR_OR_CONST Rect r{Vector2{4, 5}, Vector2{0, 7}};
		BKSGE_CONSTEXPR_EXPECT_EQ(0, r.left());
		BKSGE_CONSTEXPR_EXPECT_EQ(5, r.top());
		BKSGE_CONSTEXPR_EXPECT_EQ(4, r.right());
		BKSGE_CONSTEXPR_EXPECT_EQ(7, r.bottom());
	}
	{
		BKSGE_CONSTEXPR_OR_CONST Rect r = {Vector2{7, 8}, Vector2{9, 10}};
		BKSGE_CONSTEXPR_EXPECT_EQ( 7, r.left());
		BKSGE_CONSTEXPR_EXPECT_EQ( 8, r.top());
		BKSGE_CONSTEXPR_EXPECT_EQ( 9, r.right());
		BKSGE_CONSTEXPR_EXPECT_EQ(10, r.bottom());
	}
}
...
TYPED_TEST(MathRectTest, Vector2Size2ConstructTest)
{
	...
	{
		BKSGE_CONSTEXPR_OR_CONST Rect r(Vector2{1, 2}, Size2{3, 4});
		BKSGE_CONSTEXPR_EXPECT_EQ(1, r.left());
		BKSGE_CONSTEXPR_EXPECT_EQ(2, r.top());
		BKSGE_CONSTEXPR_EXPECT_EQ(4, r.right());
		BKSGE_CONSTEXPR_EXPECT_EQ(6, r.bottom());
	}
	{
		BKSGE_CONSTEXPR_OR_CONST Rect r{Vector2{4, 5}, Size2{6, 7}};
		BKSGE_CONSTEXPR_EXPECT_EQ( 4, r.left());
		BKSGE_CONSTEXPR_EXPECT_EQ( 5, r.top());
		BKSGE_CONSTEXPR_EXPECT_EQ(10, r.right());
		BKSGE_CONSTEXPR_EXPECT_EQ(12, r.bottom());
	}
	{
		BKSGE_CONSTEXPR_OR_CONST Rect r = {Vector2{7, 8}, Size2{9, 10}};
		BKSGE_CONSTEXPR_EXPECT_EQ( 7, r.left());
		BKSGE_CONSTEXPR_EXPECT_EQ( 8, r.top());
		BKSGE_CONSTEXPR_EXPECT_EQ(16, r.right());
		BKSGE_CONSTEXPR_EXPECT_EQ(18, r.bottom());
	}
}
...
TYPED_TEST(MathRectTest, CopyConstructTest)
{
	...
	BKSGE_CONSTEXPR_OR_CONST Rect  r1{Vector2{1, 2}, Vector2{3, 4}};
	BKSGE_CONSTEXPR_OR_CONST Rect  r2{r1};
	BKSGE_CONSTEXPR_OR_CONST Recti r3{r2};
	BKSGE_CONSTEXPR_OR_CONST Rectf r4{r2};

	BKSGE_CONSTEXPR_EXPECT_EQ(1, r1.left());
	BKSGE_CONSTEXPR_EXPECT_EQ(2, r1.top());
	BKSGE_CONSTEXPR_EXPECT_EQ(3, r1.right());
	BKSGE_CONSTEXPR_EXPECT_EQ(4, r1.bottom());
	BKSGE_CONSTEXPR_EXPECT_EQ(1, r2.left());
	BKSGE_CONSTEXPR_EXPECT_EQ(2, r2.top());
	BKSGE_CONSTEXPR_EXPECT_EQ(3, r2.right());
	BKSGE_CONSTEXPR_EXPECT_EQ(4, r2.bottom());
	BKSGE_CONSTEXPR_EXPECT_EQ(1, r3.left());
	BKSGE_CONSTEXPR_EXPECT_EQ(2, r3.top());
	BKSGE_CONSTEXPR_EXPECT_EQ(3, r3.right());
	BKSGE_CONSTEXPR_EXPECT_EQ(4, r3.bottom());
	BKSGE_CONSTEXPR_EXPECT_EQ(1, r4.left());
	BKSGE_CONSTEXPR_EXPECT_EQ(2, r4.top());
	BKSGE_CONSTEXPR_EXPECT_EQ(3, r4.right());
	BKSGE_CONSTEXPR_EXPECT_EQ(4, r4.bottom());
}
...
TYPED_TEST(MathRectTest, CompareTest)
{
	...
	BKSGE_CONSTEXPR_OR_CONST Rect r1(Vector2{1, 2}, Vector2{ 3, 4});
	BKSGE_CONSTEXPR_OR_CONST Rect r2(Vector2{1, 2}, Vector2{ 3, 4});
	BKSGE_CONSTEXPR_OR_CONST Rect r3(Vector2{2, 2}, Vector2{ 3, 4});
	BKSGE_CONSTEXPR_OR_CONST Rect r4(Vector2{1, 0}, Vector2{ 3, 4});
	BKSGE_CONSTEXPR_OR_CONST Rect r5(Vector2{1, 2}, Vector2{-3, 4});
	BKSGE_CONSTEXPR_OR_CONST Rect r6(Vector2{1, 2}, Vector2{ 3, 5});

	BKSGE_CONSTEXPR_EXPECT_TRUE (r1 == r1);
	BKSGE_CONSTEXPR_EXPECT_TRUE (r1 == r2);
	BKSGE_CONSTEXPR_EXPECT_FALSE(r1 == r3);
	BKSGE_CONSTEXPR_EXPECT_FALSE(r1 == r4);
	BKSGE_CONSTEXPR_EXPECT_FALSE(r1 == r5);
	BKSGE_CONSTEXPR_EXPECT_FALSE(r1 == r6);

	BKSGE_CONSTEXPR_EXPECT_FALSE(r1 != r1);
	BKSGE_CONSTEXPR_EXPECT_FALSE(r1 != r2);
	BKSGE_CONSTEXPR_EXPECT_TRUE (r1 != r3);
	BKSGE_CONSTEXPR_EXPECT_TRUE (r1 != r4);
	BKSGE_CONSTEXPR_EXPECT_TRUE (r1 != r5);
	BKSGE_CONSTEXPR_EXPECT_TRUE (r1 != r6);
}
