...
#ifndef UNIT_TEST_SERIALIZATION_SERIALIZATION_TEST_UTILITY_HPP
#define UNIT_TEST_SERIALIZATION_SERIALIZATION_TEST_UTILITY_HPP
...
#endif // UNIT_TEST_SERIALIZATION_SERIALIZATION_TEST_UTILITY_HPP
