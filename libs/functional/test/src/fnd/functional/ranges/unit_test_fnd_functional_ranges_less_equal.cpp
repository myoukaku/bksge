/**
 *	@file	unit_test_fnd_functional_ranges_less_equal.cpp
 *
 *	@brief	ranges::less_equal のテスト
 *
 *	@author	myoukaku
 */
...
namespace ranges_less_equal_test
{
...
GTEST_TEST(FunctionalTest, RangesLessEqualTest)
{
	using F = bksge::ranges::less_equal;
	...
	static_assert( bksge::ranges::less_equal{}(99, 99.0), "");
	static_assert(!bksge::ranges::less_equal{}(99.01, 99), "");
	static_assert( bksge::ranges::less_equal{}(99, 140L), "");
