/**
 *	@file	unit_test_fnd_algorithm_max_element.cpp
 *
...
{
	{
		...
		{
			BKSGE_CXX14_CONSTEXPR_OR_CONST auto ret = bksge::max_element(bksge::begin(a), bksge::end(a));
			BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE(ret == bksge::next(bksge::begin(a), 4));
		}
		{
			BKSGE_CXX14_CONSTEXPR_OR_CONST auto ret = bksge::max_element(bksge::begin(a), bksge::end(a), pred1);
			BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE(ret == bksge::next(bksge::begin(a), 5));
		}
		{
			BKSGE_CXX14_CONSTEXPR_OR_CONST auto ret = bksge::max_element(bksge::begin(a), bksge::end(a), pred2());
			BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE(ret == bksge::next(bksge::begin(a), 5));
		}
	}
	{
		...
		{
			BKSGE_CXX17_CONSTEXPR_OR_CONST auto ret = bksge::max_element(bksge::begin(a), bksge::end(a));
			BKSGE_CXX17_CONSTEXPR_EXPECT_TRUE(ret == bksge::next(bksge::begin(a), 6));
		}
		{
			BKSGE_CXX17_CONSTEXPR_OR_CONST auto ret = bksge::max_element(bksge::begin(a), bksge::end(a), pred1);
			BKSGE_CXX17_CONSTEXPR_EXPECT_TRUE(ret == bksge::next(bksge::begin(a), 1));
		}
		{
			BKSGE_CXX17_CONSTEXPR_OR_CONST auto ret = bksge::max_element(bksge::begin(a), bksge::end(a), pred2());
			BKSGE_CXX17_CONSTEXPR_EXPECT_TRUE(ret == bksge::next(bksge::begin(a), 6));
		}
	}
	{
		...
		{
			auto ret = bksge::max_element(bksge::begin(a), bksge::end(a), pred1);
			EXPECT_TRUE(ret == bksge::next(bksge::begin(a), 2));
		}
		{
			auto ret = bksge::max_element(bksge::begin(a), bksge::end(a), [](int x, int y){return x > y; });
			EXPECT_TRUE(ret == bksge::next(bksge::begin(a), 2));
		}
	}
	{
		...
		{
			auto ret = bksge::max_element(bksge::begin(a), bksge::end(a), pred2());
			EXPECT_TRUE(ret == bksge::next(bksge::begin(a), 2));
		}
		{
			auto ret = bksge::max_element(bksge::begin(a), bksge::end(a), [](int x, int y){return x > y; });
