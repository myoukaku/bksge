...
BKSGE_RANGES_BIDIRECTIONAL_RANGE_TEST(true,  bksge::array<int, 2>);
BKSGE_RANGES_BIDIRECTIONAL_RANGE_TEST(true,  bksge::vector<int>);
BKSGE_RANGES_BIDIRECTIONAL_RANGE_TEST(true,  bksge::deque<int>);
BKSGE_RANGES_BIDIRECTIONAL_RANGE_TEST(true,  bksge::list<int>);
BKSGE_RANGES_BIDIRECTIONAL_RANGE_TEST(false, bksge::forward_list<int>);
BKSGE_RANGES_BIDIRECTIONAL_RANGE_TEST(true,  bksge::set<int>);
BKSGE_RANGES_BIDIRECTIONAL_RANGE_TEST(true,  bksge::multiset<int>);
//BKSGE_RANGES_BIDIRECTIONAL_RANGE_TEST(true,  bksge::unordered_set<int>);
//BKSGE_RANGES_BIDIRECTIONAL_RANGE_TEST(true,  bksge::unordered_multiset<int>);
BKSGE_RANGES_BIDIRECTIONAL_RANGE_TEST(true,  bksge::string);
