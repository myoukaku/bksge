...
BKSGE_RANGES_OUTPUT_RANGE_TEST(true,  bksge::array<int, 2>,           int);
BKSGE_RANGES_OUTPUT_RANGE_TEST(true,  bksge::vector<int>,             int);
BKSGE_RANGES_OUTPUT_RANGE_TEST(true,  bksge::deque<int>,              int);
BKSGE_RANGES_OUTPUT_RANGE_TEST(true,  bksge::list<int>,               int);
BKSGE_RANGES_OUTPUT_RANGE_TEST(true,  bksge::forward_list<int>,       int);
BKSGE_RANGES_OUTPUT_RANGE_TEST(false, bksge::set<int>,                int);
BKSGE_RANGES_OUTPUT_RANGE_TEST(false, bksge::multiset<int>,           int);
BKSGE_RANGES_OUTPUT_RANGE_TEST(false, bksge::unordered_set<int>,      int);
BKSGE_RANGES_OUTPUT_RANGE_TEST(false, bksge::unordered_multiset<int>, int);
