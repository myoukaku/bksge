...
#ifndef BKSGE_CORE_RENDER_GL_DETAIL_WGL_INL_WGL_CONTEXT_INL_HPP
#define BKSGE_CORE_RENDER_GL_DETAIL_WGL_INL_WGL_CONTEXT_INL_HPP
...
BKSGE_INLINE void
WglContext::MakeCurrent(bool current)
{
	if (current)
	{
		::wglMakeCurrent(m_hdc, m_hglrc);
...
#endif // BKSGE_CORE_RENDER_GL_DETAIL_WGL_INL_WGL_CONTEXT_INL_HPP
