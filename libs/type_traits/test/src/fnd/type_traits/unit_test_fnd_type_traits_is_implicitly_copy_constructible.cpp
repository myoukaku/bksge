...
#define BKSGE_IS_IMPLICITLY_COPY_CONSTRUCTIBLE_TEST(b, T)	\
	static_assert(bksge::is_implicitly_copy_constructible_v<T>      == b, #T ", " #b);	\
	static_assert(bksge::is_implicitly_copy_constructible<T>::value == b, #T ", " #b);	\
	static_assert(bksge::is_implicitly_copy_constructible<T>()      == b, #T ", " #b)
...
BKSGE_IS_IMPLICITLY_COPY_CONSTRUCTIBLE_TEST(true,  Trivial);
BKSGE_IS_IMPLICITLY_COPY_CONSTRUCTIBLE_TEST(true,  Implicit);
BKSGE_IS_IMPLICITLY_COPY_CONSTRUCTIBLE_TEST(true,  ImplicitMember);
BKSGE_IS_IMPLICITLY_COPY_CONSTRUCTIBLE_TEST(false, Explicit);
BKSGE_IS_IMPLICITLY_COPY_CONSTRUCTIBLE_TEST(true,  ExplicitMember);
BKSGE_IS_IMPLICITLY_COPY_CONSTRUCTIBLE_TEST(false, NonCopyable);
BKSGE_IS_IMPLICITLY_COPY_CONSTRUCTIBLE_TEST(false, NonCopyableMember);
