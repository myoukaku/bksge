/**
 *	@file	unit_test_fnd_serialization_object_non_intrusive_split.cpp
 *
 *	@brief
 *
 *	@author	myoukaku
...
inline bool
operator==(NonIntrusiveSplitObject const& lhs, NonIntrusiveSplitObject const& rhs)
{
	return
		lhs.a == rhs.a &&
		lhs.b == rhs.b &&
...
inline void
save(Archive& ar, NonIntrusiveSplitObject const& a)
{
	ar << a.a;
	ar << a.b;
	ar << a.c;
...
template <typename Archive>
inline void
load(Archive& ar, NonIntrusiveSplitObject& a)
{
	ar >> a.a;
	ar >> a.b;
	ar >> a.c;
...
{
	using T = NonIntrusiveSplitObject;
