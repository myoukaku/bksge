...
GTEST_TEST(BigIntTest, BitShiftLeftTest)
{
	...
	EXPECT_TRUE((BitShiftLeftTest<bksge::bigint, std::int32_t>()));
	EXPECT_TRUE((BitShiftLeftTest<bksge::bigint, std::int64_t>()));
	...
	EXPECT_TRUE((BitShiftLeftTest<bksge::bigint, std::uint32_t>()));
	EXPECT_TRUE((BitShiftLeftTest<bksge::bigint, std::uint64_t>()));
...
//	EXPECT_TRUE((BitShiftLeftTest<std::int32_t,    bksge::bigint>()));
//	EXPECT_TRUE((BitShiftLeftTest<std::int64_t,    bksge::bigint>()));
...
//	EXPECT_TRUE((BitShiftLeftTest<std::uint32_t,   bksge::bigint>()));
//	EXPECT_TRUE((BitShiftLeftTest<std::uint64_t,   bksge::bigint>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int32_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int32_t, std::int64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int32_t, bksge::int128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int32_t, bksge::int256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int32_t, bksge::int512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int32_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int32_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int32_t, std::uint64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int32_t, bksge::uint128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int32_t, bksge::uint256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int32_t, bksge::uint512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int32_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int64_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int64_t, std::int64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int64_t, bksge::int128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int64_t, bksge::int256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int64_t, bksge::int512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int64_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int64_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int64_t, std::uint64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int64_t, bksge::uint128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int64_t, bksge::uint256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int64_t, bksge::uint512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::int64_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::int128_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::int128_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::int128_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::int128_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::int256_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::int256_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::int256_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::int256_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::int512_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::int512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::int512_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::int512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::int1024_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::int1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::int1024_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::int1024_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint32_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint32_t, std::int64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint32_t, bksge::int128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint32_t, bksge::int256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint32_t, bksge::int512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint32_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint32_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint32_t, std::uint64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint32_t, bksge::uint128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint32_t, bksge::uint256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint32_t, bksge::uint512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint32_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint64_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint64_t, std::int64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint64_t, bksge::int128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint64_t, bksge::int256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint64_t, bksge::int512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint64_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint64_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint64_t, std::uint64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint64_t, bksge::uint128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint64_t, bksge::uint256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint64_t, bksge::uint512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<std::uint64_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::uint128_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::uint128_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::uint128_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::uint128_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::uint256_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::uint256_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::uint256_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::uint256_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::uint512_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::uint512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::uint512_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::uint512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::uint1024_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::uint1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::uint1024_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeftTest<bksge::uint1024_t, std::uint64_t>()));
	...
	EXPECT_TRUE((BitShiftLeft2Test<bksge::bigint, std::int32_t>()));
	EXPECT_TRUE((BitShiftLeft2Test<bksge::bigint, std::int64_t>()));
	...
	EXPECT_TRUE((BitShiftLeft2Test<bksge::bigint, std::uint32_t>()));
	EXPECT_TRUE((BitShiftLeft2Test<bksge::bigint, std::uint64_t>()));
	...
	EXPECT_TRUE((BitShiftLeft2Test<std::int32_t,    bksge::bigint>()));
	EXPECT_TRUE((BitShiftLeft2Test<std::int64_t,    bksge::bigint>()));
	...
	EXPECT_TRUE((BitShiftLeft2Test<std::uint32_t,   bksge::bigint>()));
	EXPECT_TRUE((BitShiftLeft2Test<std::uint64_t,   bksge::bigint>()));
	...
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int32_t, std::int32_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int32_t, std::int64_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int32_t, bksge::int128_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int32_t, bksge::int256_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int32_t, bksge::int512_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int32_t, bksge::int1024_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int32_t, std::uint32_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int32_t, std::uint64_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int32_t, bksge::uint128_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int32_t, bksge::uint256_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int32_t, bksge::uint512_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int32_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int64_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int64_t, std::int64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int64_t, bksge::int128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int64_t, bksge::int256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int64_t, bksge::int512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int64_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int64_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int64_t, std::uint64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int64_t, bksge::uint128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int64_t, bksge::uint256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int64_t, bksge::uint512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::int64_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::int128_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::int128_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::int128_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::int128_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::int256_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::int256_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::int256_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::int256_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::int512_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::int512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::int512_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::int512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::int1024_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::int1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::int1024_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::int1024_t, std::uint64_t>()));
	...
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint32_t, std::int32_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint32_t, std::int64_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint32_t, bksge::int128_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint32_t, bksge::int256_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint32_t, bksge::int512_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint32_t, bksge::int1024_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint32_t, std::uint32_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint32_t, std::uint64_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint32_t, bksge::uint128_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint32_t, bksge::uint256_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint32_t, bksge::uint512_t>()));
	//BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint32_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint64_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint64_t, std::int64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint64_t, bksge::int128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint64_t, bksge::int256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint64_t, bksge::int512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint64_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint64_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint64_t, std::uint64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint64_t, bksge::uint128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint64_t, bksge::uint256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint64_t, bksge::uint512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<std::uint64_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::uint128_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::uint128_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::uint128_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::uint128_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::uint256_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::uint256_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::uint256_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::uint256_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::uint512_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::uint512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::uint512_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::uint512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::uint1024_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::uint1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::uint1024_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftLeft2Test<bksge::uint1024_t, std::uint64_t>()));
	...
	EXPECT_TRUE((BitShiftLeft2LargeTest<bksge::bigint, std::int32_t>()));
	EXPECT_TRUE((BitShiftLeft2LargeTest<bksge::bigint, std::int64_t>()));
	...
	EXPECT_TRUE((BitShiftLeft2LargeTest<bksge::bigint, std::uint32_t>()));
	EXPECT_TRUE((BitShiftLeft2LargeTest<bksge::bigint, std::uint64_t>()));
