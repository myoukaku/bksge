...
GTEST_TEST(BigIntTest, AddTest)
{
	...
	EXPECT_TRUE((AddTest<bksge::bigint,     std::int32_t>()));
	EXPECT_TRUE((AddTest<bksge::bigint,     std::int64_t>()));
	...
	EXPECT_TRUE((AddTest<bksge::bigint,     std::uint32_t>()));
	EXPECT_TRUE((AddTest<bksge::bigint,     std::uint64_t>()));
...
//	EXPECT_TRUE((AddTest<std::int32_t,    bksge::bigint>()));
//	EXPECT_TRUE((AddTest<std::int64_t,    bksge::bigint>()));
...
//	EXPECT_TRUE((AddTest<std::uint32_t,   bksge::bigint>()));
//	EXPECT_TRUE((AddTest<std::uint64_t,   bksge::bigint>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int32_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int32_t, std::int64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int32_t, bksge::int128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int32_t, bksge::int256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int32_t, bksge::int512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int32_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int32_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int32_t, std::uint64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int32_t, bksge::uint128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int32_t, bksge::uint256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int32_t, bksge::uint512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int32_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int64_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int64_t, std::int64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int64_t, bksge::int128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int64_t, bksge::int256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int64_t, bksge::int512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int64_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int64_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int64_t, std::uint64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int64_t, bksge::uint128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int64_t, bksge::uint256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int64_t, bksge::uint512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::int64_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<bksge::int128_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<bksge::int128_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<bksge::int256_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<bksge::int256_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<bksge::int512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<bksge::int512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<bksge::int1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<bksge::int1024_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint32_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint32_t, std::int64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint32_t, bksge::int128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint32_t, bksge::int256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint32_t, bksge::int512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint32_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint32_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint32_t, std::uint64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint32_t, bksge::uint128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint32_t, bksge::uint256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint32_t, bksge::uint512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint32_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint64_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint64_t, std::int64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint64_t, bksge::int128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint64_t, bksge::int256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint64_t, bksge::int512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint64_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint64_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint64_t, std::uint64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint64_t, bksge::uint128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint64_t, bksge::uint256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint64_t, bksge::uint512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<std::uint64_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<bksge::uint128_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<bksge::uint128_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<bksge::uint256_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<bksge::uint256_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<bksge::uint512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<bksge::uint512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<bksge::uint1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((AddTest<bksge::uint1024_t, std::uint64_t>()));
...
//	/*BKSGE_CXX14_CONSTEXPR_*/EXPECT_TRUE((AddFloatTest<std::int32_t>()));
//	/*BKSGE_CXX14_CONSTEXPR_*/EXPECT_TRUE((AddFloatTest<std::int64_t>()));
...
//	/*BKSGE_CXX14_CONSTEXPR_*/EXPECT_TRUE((AddFloatTest<std::uint32_t>()));
//	/*BKSGE_CXX14_CONSTEXPR_*/EXPECT_TRUE((AddFloatTest<std::uint64_t>()));
	...
	EXPECT_TRUE((Add2Test<bksge::bigint,     std::int32_t>()));
	EXPECT_TRUE((Add2Test<bksge::bigint,     std::int64_t>()));
	...
	EXPECT_TRUE((Add2Test<bksge::bigint,     std::uint32_t>()));
	EXPECT_TRUE((Add2Test<bksge::bigint,     std::uint64_t>()));
	...
	EXPECT_TRUE((Add2Test<std::int32_t,    bksge::bigint>()));
	EXPECT_TRUE((Add2Test<std::int64_t,    bksge::bigint>()));
	...
	EXPECT_TRUE((Add2Test<std::uint32_t,   bksge::bigint>()));
	EXPECT_TRUE((Add2Test<std::uint64_t,   bksge::bigint>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int32_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int32_t, std::int64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int32_t, bksge::int128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int32_t, bksge::int256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int32_t, bksge::int512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int32_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int32_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int32_t, std::uint64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int32_t, bksge::uint128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int32_t, bksge::uint256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int32_t, bksge::uint512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int32_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int64_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int64_t, std::int64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int64_t, bksge::int128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int64_t, bksge::int256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int64_t, bksge::int512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int64_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int64_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int64_t, std::uint64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int64_t, bksge::uint128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int64_t, bksge::uint256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int64_t, bksge::uint512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::int64_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::int128_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::int128_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::int128_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::int128_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::int256_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::int256_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::int256_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::int256_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::int512_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::int512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::int512_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::int512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::int1024_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::int1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::int1024_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::int1024_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint32_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint32_t, std::int64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint32_t, bksge::int128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint32_t, bksge::int256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint32_t, bksge::int512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint32_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint32_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint32_t, std::uint64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint32_t, bksge::uint128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint32_t, bksge::uint256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint32_t, bksge::uint512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint32_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint64_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint64_t, std::int64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint64_t, bksge::int128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint64_t, bksge::int256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint64_t, bksge::int512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint64_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint64_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint64_t, std::uint64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint64_t, bksge::uint128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint64_t, bksge::uint256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint64_t, bksge::uint512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<std::uint64_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::uint128_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::uint128_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::uint128_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::uint128_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::uint256_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::uint256_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::uint256_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::uint256_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::uint512_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::uint512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::uint512_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::uint512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::uint1024_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::uint1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::uint1024_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2Test<bksge::uint1024_t, std::uint64_t>()));
...
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2FloatTest<std::int32_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2FloatTest<std::int64_t>()));
...
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2FloatTest<std::uint32_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Add2FloatTest<std::uint64_t>()));
