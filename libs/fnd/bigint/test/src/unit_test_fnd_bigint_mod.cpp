...
GTEST_TEST(BigIntTest, ModTest)
{
	...
	EXPECT_TRUE((ModTest<bksge::bigint,     std::int32_t>()));
	EXPECT_TRUE((ModTest<bksge::bigint,     std::int64_t>()));
	...
	EXPECT_TRUE((ModTest<bksge::bigint,     std::uint32_t>()));
	EXPECT_TRUE((ModTest<bksge::bigint,     std::uint64_t>()));
...
//	EXPECT_TRUE((ModTest<std::int32_t,    bksge::bigint>()));
//	EXPECT_TRUE((ModTest<std::int64_t,    bksge::bigint>()));
...
//	EXPECT_TRUE((ModTest<std::uint32_t,   bksge::bigint>()));
//	EXPECT_TRUE((ModTest<std::uint64_t,   bksge::bigint>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int32_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int32_t, std::int64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int32_t, bksge::int128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int32_t, bksge::int256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int32_t, bksge::int512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int32_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int32_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int32_t, std::uint64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int32_t, bksge::uint128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int32_t, bksge::uint256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int32_t, bksge::uint512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int32_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int64_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int64_t, std::int64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int64_t, bksge::int128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int64_t, bksge::int256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int64_t, bksge::int512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int64_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int64_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int64_t, std::uint64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int64_t, bksge::uint128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int64_t, bksge::uint256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int64_t, bksge::uint512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<std::int64_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<bksge::int128_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<bksge::int128_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<bksge::int128_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<bksge::int128_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<bksge::int256_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<bksge::int256_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<bksge::int256_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<bksge::int256_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<bksge::int512_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<bksge::int512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<bksge::int512_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<bksge::int512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<bksge::int1024_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<bksge::int1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<bksge::int1024_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((ModTest<bksge::int1024_t, std::uint64_t>()));
	...
	EXPECT_TRUE((Mod2Test<bksge::bigint, std::int32_t>()));
	EXPECT_TRUE((Mod2Test<bksge::bigint, std::int64_t>()));
	...
	EXPECT_TRUE((Mod2UnsignedTest<bksge::bigint, std::uint32_t>()));
	EXPECT_TRUE((Mod2UnsignedTest<bksge::bigint, std::uint64_t>()));
	...
	EXPECT_TRUE((Mod2Test<std::int32_t, bksge::bigint>()));
	EXPECT_TRUE((Mod2Test<std::int64_t, bksge::bigint>()));
	...
	EXPECT_TRUE((Mod2UnsignedTest<std::uint32_t, bksge::bigint>()));
	EXPECT_TRUE((Mod2UnsignedTest<std::uint64_t, bksge::bigint>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<std::int32_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<std::int32_t, std::int64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<std::int32_t, bksge::int128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<std::int32_t, bksge::int256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<std::int32_t, bksge::int512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<std::int32_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::int32_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::int32_t, std::uint64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::int32_t, bksge::uint128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::int32_t, bksge::uint256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::int32_t, bksge::uint512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::int32_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<std::int64_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<std::int64_t, std::int64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<std::int64_t, bksge::int128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<std::int64_t, bksge::int256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<std::int64_t, bksge::int512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<std::int64_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::int64_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::int64_t, std::uint64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::int64_t, bksge::uint128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::int64_t, bksge::uint256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::int64_t, bksge::uint512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::int64_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<bksge::int128_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<bksge::int128_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::int128_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::int128_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<bksge::int256_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<bksge::int256_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::int256_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::int256_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<bksge::int512_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<bksge::int512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::int512_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::int512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<bksge::int1024_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2Test<bksge::int1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::int1024_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::int1024_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint32_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint32_t, std::int64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint32_t, bksge::int128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint32_t, bksge::int256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint32_t, bksge::int512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint32_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint32_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint32_t, std::uint64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint32_t, bksge::uint128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint32_t, bksge::uint256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint32_t, bksge::uint512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint32_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint64_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint64_t, std::int64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint64_t, bksge::int128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint64_t, bksge::int256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint64_t, bksge::int512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint64_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint64_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint64_t, std::uint64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint64_t, bksge::uint128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint64_t, bksge::uint256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint64_t, bksge::uint512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<std::uint64_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::uint128_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::uint128_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::uint128_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::uint128_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::uint256_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::uint256_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::uint256_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::uint256_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::uint512_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::uint512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::uint512_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::uint512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::uint1024_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::uint1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::uint1024_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((Mod2UnsignedTest<bksge::uint1024_t, std::uint64_t>()));
