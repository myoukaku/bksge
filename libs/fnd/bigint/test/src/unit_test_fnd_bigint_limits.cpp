...
static_assert(std::numeric_limits<std::int64_t   >::max_digits10 == 0, "");
...
static_assert(std::numeric_limits<std::uint64_t  >::max_digits10 == 0, "");
...
static_assert(std::numeric_limits<std::int64_t   >::is_signed == true, "");
...
static_assert(std::numeric_limits<std::uint64_t  >::is_signed == false, "");
...
static_assert(std::numeric_limits<std::int64_t   >::is_integer == true, "");
...
static_assert(std::numeric_limits<std::uint64_t  >::is_integer == true, "");
...
static_assert(std::numeric_limits<std::int64_t   >::is_exact == true, "");
...
static_assert(std::numeric_limits<std::uint64_t  >::is_exact == true, "");
...
static_assert(std::numeric_limits<std::int64_t   >::radix == 2, "");
...
static_assert(std::numeric_limits<std::int64_t   >::min_exponent == 0, "");
...
static_assert(std::numeric_limits<std::uint64_t  >::min_exponent == 0, "");
...
static_assert(std::numeric_limits<std::int64_t   >::min_exponent10 == 0, "");
...
static_assert(std::numeric_limits<std::uint64_t  >::min_exponent10 == 0, "");
...
static_assert(std::numeric_limits<std::int64_t   >::max_exponent == 0, "");
...
static_assert(std::numeric_limits<std::uint64_t  >::max_exponent == 0, "");
...
static_assert(std::numeric_limits<std::int64_t   >::max_exponent10 == 0, "");
...
static_assert(std::numeric_limits<std::uint64_t  >::max_exponent10 == 0, "");
...
static_assert(std::numeric_limits<std::int64_t   >::has_infinity == false, "");
...
static_assert(std::numeric_limits<std::uint64_t  >::has_infinity == false, "");
...
static_assert(std::numeric_limits<std::int64_t   >::has_quiet_NaN == false, "");
...
static_assert(std::numeric_limits<std::uint64_t  >::has_quiet_NaN == false, "");
...
static_assert(std::numeric_limits<std::int64_t   >::has_signaling_NaN == false, "");
...
static_assert(std::numeric_limits<std::uint64_t  >::has_signaling_NaN == false, "");
...
static_assert(std::numeric_limits<std::int64_t   >::has_denorm == std::denorm_absent, "");
...
static_assert(std::numeric_limits<std::uint64_t  >::has_denorm == std::denorm_absent, "");
...
static_assert(std::numeric_limits<std::int64_t   >::has_denorm_loss == false, "");
...
static_assert(std::numeric_limits<std::uint64_t  >::has_denorm_loss == false, "");
...
static_assert(std::numeric_limits<std::int64_t   >::is_iec559 == false, "");
...
static_assert(std::numeric_limits<std::uint64_t  >::is_iec559 == false, "");
...
static_assert(std::numeric_limits<std::int64_t   >::is_bounded == true, "");
...
static_assert(std::numeric_limits<std::uint64_t  >::is_bounded == true, "");
...
static_assert(std::numeric_limits<std::int64_t   >::is_modulo == false, "");
...
static_assert(std::numeric_limits<std::uint64_t  >::is_modulo == true, "");
...
static_assert(std::numeric_limits<std::int64_t   >::traps == false, "");
...
static_assert(std::numeric_limits<std::uint64_t  >::traps == false, "");
...
static_assert(std::numeric_limits<std::int64_t   >::tinyness_before == false, "");
...
static_assert(std::numeric_limits<std::uint64_t  >::tinyness_before == false, "");
...
static_assert(std::numeric_limits<std::int64_t   >::round_style == std::round_toward_zero, "");
...
static_assert(std::numeric_limits<std::uint64_t  >::round_style == std::round_toward_zero, "");
...
GTEST_TEST(BigIntTest, LimitsTest)
{
	...
	EXPECT_TRUE(std::numeric_limits<std::int64_t   >::min() == -0x7fffffffffffffff - 1);
	...
	EXPECT_TRUE(std::numeric_limits<std::uint64_t  >::min() == 0);
	...
	EXPECT_TRUE(std::numeric_limits<std::int64_t   >::min() < 0);
	...
	EXPECT_TRUE(std::numeric_limits<std::int64_t   >::max() == 0x7fffffffffffffff);
	...
	EXPECT_TRUE(std::numeric_limits<bksge::int1024_t >::max() == bksge::int1024_t(""));
	EXPECT_TRUE(std::numeric_limits<std::uint64_t  >::max() == 0xffffffffffffffff);
	...
	EXPECT_TRUE(std::numeric_limits<std::int64_t   >::max() > 0);
	...
	EXPECT_TRUE(std::numeric_limits<std::uint64_t  >::max() > 0);
	...
	EXPECT_TRUE(std::numeric_limits<std::int64_t   >::min() < std::numeric_limits<std::int64_t   >::max());
	...
	EXPECT_TRUE(std::numeric_limits<std::uint64_t  >::min() < std::numeric_limits<std::uint64_t  >::max());
	...
	EXPECT_TRUE(std::numeric_limits<std::int64_t   >::lowest() == std::numeric_limits<std::int64_t   >::min());
	...
	EXPECT_TRUE(std::numeric_limits<std::uint64_t  >::lowest() == std::numeric_limits<std::uint64_t  >::min());
	...
	EXPECT_TRUE(std::numeric_limits<std::int64_t   >::epsilon() == 0);
	...
	EXPECT_TRUE(std::numeric_limits<std::uint64_t  >::epsilon() == 0);
	...
	EXPECT_TRUE(std::numeric_limits<std::int64_t   >::round_error() == 0);
	...
	EXPECT_TRUE(std::numeric_limits<std::uint64_t  >::round_error() == 0);
	...
	EXPECT_TRUE(std::numeric_limits<std::int64_t   >::infinity() == 0);
	...
	EXPECT_TRUE(std::numeric_limits<std::uint64_t  >::infinity() == 0);
	...
	EXPECT_TRUE(std::numeric_limits<std::int64_t   >::quiet_NaN() == 0);
	...
	EXPECT_TRUE(std::numeric_limits<std::uint64_t  >::quiet_NaN() == 0);
	...
	EXPECT_TRUE(std::numeric_limits<std::int64_t   >::signaling_NaN() == 0);
	...
	EXPECT_TRUE(std::numeric_limits<std::uint64_t  >::signaling_NaN() == 0);
	...
	EXPECT_TRUE(std::numeric_limits<std::int64_t   >::denorm_min() == 0);
	...
	EXPECT_TRUE(std::numeric_limits<std::uint64_t  >::denorm_min() == 0);
