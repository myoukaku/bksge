...
GTEST_TEST(BigIntTest, BitOrTest)
{
	...
	EXPECT_TRUE((BitOrTest<bksge::bigint, std::int64_t>()));
	...
	EXPECT_TRUE((BitOrTest<bksge::bigint, std::uint64_t>()));
...
//	EXPECT_TRUE((BitOrTest<std::int64_t, bksge::bigint>()));
...
//	EXPECT_TRUE((BitOrTest<std::uint64_t, bksge::bigint>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOrTest<bksge::int128_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOrTest<bksge::int128_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOrTest<bksge::int256_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOrTest<bksge::int256_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOrTest<bksge::int512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOrTest<bksge::int512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOrTest<bksge::int1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOrTest<bksge::int1024_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOrTest<bksge::uint128_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOrTest<bksge::uint128_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOrTest<bksge::uint256_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOrTest<bksge::uint256_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOrTest<bksge::uint512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOrTest<bksge::uint512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOrTest<bksge::uint1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOrTest<bksge::uint1024_t, std::uint64_t>()));
	...
	EXPECT_TRUE((BitOr2Test<bksge::bigint, std::int64_t>()));
	...
	EXPECT_TRUE((BitOr2Test<bksge::bigint, std::uint64_t>()));
	...
	EXPECT_TRUE((BitOr2Test<std::int64_t, bksge::bigint>()));
	...
	EXPECT_TRUE((BitOr2Test<std::uint64_t, bksge::bigint>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::int64_t, std::int64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::int64_t, bksge::int128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::int64_t, bksge::int256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::int64_t, bksge::int512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::int64_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::int64_t, std::uint64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::int64_t, bksge::uint128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::int64_t, bksge::uint256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::int64_t, bksge::uint512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::int64_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<bksge::int128_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<bksge::int128_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<bksge::int256_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<bksge::int256_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<bksge::int512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<bksge::int512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<bksge::int1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<bksge::int1024_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::uint64_t, std::int64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::uint64_t, bksge::int128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::uint64_t, bksge::int256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::uint64_t, bksge::int512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::uint64_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::uint64_t, std::uint64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::uint64_t, bksge::uint128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::uint64_t, bksge::uint256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::uint64_t, bksge::uint512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<std::uint64_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<bksge::uint128_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<bksge::uint128_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<bksge::uint256_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<bksge::uint256_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<bksge::uint512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<bksge::uint512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<bksge::uint1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitOr2Test<bksge::uint1024_t, std::uint64_t>()));
