...
GTEST_TEST(BigIntTest, BitShiftRightTest)
{
	...
	EXPECT_TRUE((BitShiftRightTest<bksge::bigint, std::int32_t>()));
	EXPECT_TRUE((BitShiftRightTest<bksge::bigint, std::int64_t>()));
	...
	EXPECT_TRUE((BitShiftRightTest<bksge::bigint, std::uint32_t>()));
	EXPECT_TRUE((BitShiftRightTest<bksge::bigint, std::uint64_t>()));
...
//	EXPECT_TRUE((BitShiftRightTest<std::int32_t,    bksge::bigint>()));
//	EXPECT_TRUE((BitShiftRightTest<std::int64_t,    bksge::bigint>()));
...
//	EXPECT_TRUE((BitShiftRightTest<std::uint32_t,   bksge::bigint>()));
//	EXPECT_TRUE((BitShiftRightTest<std::uint64_t,   bksge::bigint>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int32_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int32_t, std::int64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int32_t, bksge::int128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int32_t, bksge::int256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int32_t, bksge::int512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int32_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int32_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int32_t, std::uint64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int32_t, bksge::uint128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int32_t, bksge::uint256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int32_t, bksge::uint512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int32_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int64_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int64_t, std::int64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int64_t, bksge::int128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int64_t, bksge::int256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int64_t, bksge::int512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int64_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int64_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int64_t, std::uint64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int64_t, bksge::uint128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int64_t, bksge::uint256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int64_t, bksge::uint512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::int64_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::int128_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::int128_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::int128_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::int128_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::int256_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::int256_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::int256_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::int256_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::int512_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::int512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::int512_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::int512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::int1024_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::int1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::int1024_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::int1024_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint32_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint32_t, std::int64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint32_t, bksge::int128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint32_t, bksge::int256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint32_t, bksge::int512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint32_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint32_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint32_t, std::uint64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint32_t, bksge::uint128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint32_t, bksge::uint256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint32_t, bksge::uint512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint32_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint64_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint64_t, std::int64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint64_t, bksge::int128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint64_t, bksge::int256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint64_t, bksge::int512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint64_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint64_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint64_t, std::uint64_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint64_t, bksge::uint128_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint64_t, bksge::uint256_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint64_t, bksge::uint512_t>()));
//	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<std::uint64_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::uint128_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::uint128_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::uint128_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::uint128_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::uint256_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::uint256_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::uint256_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::uint256_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::uint512_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::uint512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::uint512_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::uint512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::uint1024_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::uint1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::uint1024_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRightTest<bksge::uint1024_t, std::uint64_t>()));
	...
	EXPECT_TRUE((BitShiftRight2Test<bksge::bigint, std::int32_t>()));
	EXPECT_TRUE((BitShiftRight2Test<bksge::bigint, std::int64_t>()));
	...
	EXPECT_TRUE((BitShiftRight2Test<bksge::bigint, std::uint32_t>()));
	EXPECT_TRUE((BitShiftRight2Test<bksge::bigint, std::uint64_t>()));
...
//	EXPECT_TRUE((BitShiftRight2Test<std::int32_t,    bksge::bigint>()));
//	EXPECT_TRUE((BitShiftRight2Test<std::int64_t,    bksge::bigint>()));
...
//	EXPECT_TRUE((BitShiftRight2Test<std::uint32_t,   bksge::bigint>()));
//	EXPECT_TRUE((BitShiftRight2Test<std::uint64_t,   bksge::bigint>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int32_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int32_t, std::int64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int32_t, bksge::int128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int32_t, bksge::int256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int32_t, bksge::int512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int32_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int32_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int32_t, std::uint64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int32_t, bksge::uint128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int32_t, bksge::uint256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int32_t, bksge::uint512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int32_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int64_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int64_t, std::int64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int64_t, bksge::int128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int64_t, bksge::int256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int64_t, bksge::int512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int64_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int64_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int64_t, std::uint64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int64_t, bksge::uint128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int64_t, bksge::uint256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int64_t, bksge::uint512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::int64_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::int128_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::int128_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::int128_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::int128_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::int256_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::int256_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::int256_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::int256_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::int512_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::int512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::int512_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::int512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::int1024_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::int1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::int1024_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::int1024_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint32_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint32_t, std::int64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint32_t, bksge::int128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint32_t, bksge::int256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint32_t, bksge::int512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint32_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint32_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint32_t, std::uint64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint32_t, bksge::uint128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint32_t, bksge::uint256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint32_t, bksge::uint512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint32_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint64_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint64_t, std::int64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint64_t, bksge::int128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint64_t, bksge::int256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint64_t, bksge::int512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint64_t, bksge::int1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint64_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint64_t, std::uint64_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint64_t, bksge::uint128_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint64_t, bksge::uint256_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint64_t, bksge::uint512_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<std::uint64_t, bksge::uint1024_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::uint128_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::uint128_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::uint128_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::uint128_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::uint256_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::uint256_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::uint256_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::uint256_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::uint512_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::uint512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::uint512_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::uint512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::uint1024_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::uint1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::uint1024_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2Test<bksge::uint1024_t, std::uint64_t>()));
...
//	EXPECT_TRUE((BitShiftRight2LargeTest<bksge::uint256_t,  bksge::bigint>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2LargeTest<bksge::int512_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2LargeTest<bksge::int512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2LargeTest<bksge::int512_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2LargeTest<bksge::int512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2LargeTest<bksge::int1024_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2LargeTest<bksge::int1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2LargeTest<bksge::int1024_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2LargeTest<bksge::int1024_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2LargeTest<bksge::uint512_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2LargeTest<bksge::uint512_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2LargeTest<bksge::uint512_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2LargeTest<bksge::uint512_t, std::uint64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2LargeTest<bksge::uint1024_t, std::int32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2LargeTest<bksge::uint1024_t, std::int64_t>()));
	...
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2LargeTest<bksge::uint1024_t, std::uint32_t>()));
	BKSGE_CXX14_CONSTEXPR_EXPECT_TRUE((BitShiftRight2LargeTest<bksge::uint1024_t, std::uint64_t>()));
