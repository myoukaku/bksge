...
public:
	...
	static bksge::pair<T*, std::size_t> deallocate_called;
	...
	{
		deallocate_called = bksge::pair<T*, std::size_t>(p, n);
	}
...
template <typename T> bksge::pair<T*, std::size_t> A1<T>::deallocate_called;
