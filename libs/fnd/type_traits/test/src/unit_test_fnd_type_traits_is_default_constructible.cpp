...
BKSGE_IS_DEFAULT_CONSTRUCTIBLE_TEST(true,  S1);
BKSGE_IS_DEFAULT_CONSTRUCTIBLE_TEST(true,  S2);
BKSGE_IS_DEFAULT_CONSTRUCTIBLE_TEST(true,  S3);
BKSGE_IS_DEFAULT_CONSTRUCTIBLE_TEST(true,  S4);
BKSGE_IS_DEFAULT_CONSTRUCTIBLE_TEST(false, S5);
BKSGE_IS_DEFAULT_CONSTRUCTIBLE_TEST(false, S6);
...
BKSGE_IS_DEFAULT_CONSTRUCTIBLE_TEST(true,  bksge::nullptr_t);
