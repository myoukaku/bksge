...
#define BKSGE_IS_NOTHROW_MOVE_ASSIGNABLE_TEST(b, T)	\
	static_assert(bksge::is_nothrow_move_assignable_v<T>      == b, #T ", " #b);	\
	static_assert(bksge::is_nothrow_move_assignable<T>::value == b, #T ", " #b);	\
	static_assert(bksge::is_nothrow_move_assignable<T>()      == b, #T ", " #b)
...
BKSGE_IS_NOTHROW_MOVE_ASSIGNABLE_TEST(true,  S1);
BKSGE_IS_NOTHROW_MOVE_ASSIGNABLE_TEST(true,  S2);
BKSGE_IS_NOTHROW_MOVE_ASSIGNABLE_TEST(true,  S3);
BKSGE_IS_NOTHROW_MOVE_ASSIGNABLE_TEST(false, S4);
BKSGE_IS_NOTHROW_MOVE_ASSIGNABLE_TEST(false, S5);
BKSGE_IS_NOTHROW_MOVE_ASSIGNABLE_TEST(false, S6);
...
BKSGE_IS_NOTHROW_MOVE_ASSIGNABLE_TEST(true, std::size_t);
