...
static_assert(bksge::is_same<float,       decltype(bksge::sinh(0.0f))>::value, "");
static_assert(bksge::is_same<float,       decltype(bksge::sinhf(0.0f))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::sinh(0.0 ))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::sinh(0   ))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::sinh(0.0l))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::sinhl(0.0l))>::value, "");
