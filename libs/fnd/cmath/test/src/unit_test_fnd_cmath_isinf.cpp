/**
 *	@file	unit_test_fnd_cmath_isinf.cpp
 *
 *	@brief	isinf のテスト
 *
 *	@author	myoukaku
...
static_assert(bksge::is_same<bool, decltype(bksge::isinf(0.0f))>::value, "");
static_assert(bksge::is_same<bool, decltype(bksge::isinf(0.0 ))>::value, "");
static_assert(bksge::is_same<bool, decltype(bksge::isinf(0.0l))>::value, "");
static_assert(bksge::is_same<bool, decltype(bksge::isinf(0   ))>::value, "");
