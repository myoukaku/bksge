/**
 *	@file	unit_test_fnd_cmath_round_up.cpp
 *
 *	@brief	round_up のテスト
 *
 *	@author	myoukaku
...
static_assert(bksge::is_same<float,       decltype(bksge::round_up(0.0f, 0.0f))>::value, "");
static_assert(bksge::is_same<float,       decltype(bksge::round_up(0.0f, 0.0 ))>::value, "");
static_assert(bksge::is_same<float,       decltype(bksge::round_up(0.0f, 0.0l))>::value, "");
static_assert(bksge::is_same<float,       decltype(bksge::round_up(0.0f, 0   ))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::round_up(0.0 , 0.0f))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::round_up(0.0 , 0.0 ))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::round_up(0.0 , 0.0l))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::round_up(0.0 , 0   ))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::round_up(0.0l, 0.0f))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::round_up(0.0l, 0.0 ))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::round_up(0.0l, 0.0l))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::round_up(0.0l, 0   ))>::value, "");
static_assert(bksge::is_same<int,         decltype(bksge::round_up(0   , 0.0f))>::value, "");
static_assert(bksge::is_same<int,         decltype(bksge::round_up(0   , 0.0 ))>::value, "");
static_assert(bksge::is_same<int,         decltype(bksge::round_up(0   , 0.0l))>::value, "");
static_assert(bksge::is_same<int,         decltype(bksge::round_up(0   , 0   ))>::value, "");
