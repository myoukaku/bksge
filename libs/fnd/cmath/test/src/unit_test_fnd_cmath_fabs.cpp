...
static_assert(bksge::is_same<float,       decltype(bksge::fabs(0.0f))>::value, "");
static_assert(bksge::is_same<float,       decltype(bksge::fabsf(0.0f))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::fabs(0.0 ))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::fabs(0   ))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::fabs(0.0l))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::fabsl(0.0l))>::value, "");
