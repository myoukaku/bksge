...
static_assert(bksge::is_same<float,       decltype(bksge::radians_to_degrees(0.0f))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::radians_to_degrees(0.0 ))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::radians_to_degrees(0.0l))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::radians_to_degrees(0   ))>::value, "");
