...
#ifndef BKSGE_FND_ALGORITHM_RANGES_SET_INTERSECTION_HPP
#define BKSGE_FND_ALGORITHM_RANGES_SET_INTERSECTION_HPP
...
struct set_intersection_fn
{
	...
	>
#endif
	BKSGE_CXX14_CONSTEXPR set_intersection_result<Iter1, Iter2, Out>
	operator()(
		...
		Proj2 proj2 = {}) const
	{
		...
		auto last1i = ranges::next(bksge::move(first1), bksge::move(last1));
		auto last2i = ranges::next(bksge::move(first2), bksge::move(last2));
		return { bksge::move(last1i), bksge::move(last2i), bksge::move(result) };
	}
...
BKSGE_INLINE_VAR BKSGE_CONSTEXPR set_intersection_fn set_intersection{};
...
#endif // BKSGE_FND_ALGORITHM_RANGES_SET_INTERSECTION_HPP
