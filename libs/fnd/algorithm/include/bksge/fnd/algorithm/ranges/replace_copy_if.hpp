...
#ifndef BKSGE_FND_ALGORITHM_RANGES_REPLACE_COPY_IF_HPP
#define BKSGE_FND_ALGORITHM_RANGES_REPLACE_COPY_IF_HPP
...
struct replace_copy_if_fn
{
	...
	template <
		...
		typename T,
		bksge::output_iterator<T const&> Out,
	...
	template <
		...
		typename = bksge::enable_if_t<bksge::conjunction<
			...
			bksge::output_iterator<Out, T const&>,
...
BKSGE_INLINE_VAR BKSGE_CONSTEXPR replace_copy_if_fn replace_copy_if{};
...
#endif // BKSGE_FND_ALGORITHM_RANGES_REPLACE_COPY_IF_HPP
