 ...
 *
 *	@brief	ranges::remove_copy_if の定義
 *
 *	@author	myoukaku
 */

#ifndef BKSGE_FND_ALGORITHM_RANGES_REMOVE_COPY_IF_HPP
#define BKSGE_FND_ALGORITHM_RANGES_REMOVE_COPY_IF_HPP
...
using remove_copy_if_result = in_out_result<Iter, Out>;
...
struct remove_copy_if_fn
{
	...
	>
#endif
	BKSGE_CXX14_CONSTEXPR remove_copy_if_result<Iter, Out>
	operator()(
	...
	remove_copy_if_result<ranges::borrowed_iterator_t<Range>, Out>
...
BKSGE_INLINE_VAR BKSGE_CONSTEXPR remove_copy_if_fn remove_copy_if{};
...
#endif // BKSGE_FND_ALGORITHM_RANGES_REMOVE_COPY_IF_HPP
