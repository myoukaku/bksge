 ...
 *	@file	sort_heap.hpp
 *
 *	@brief	ranges::sort_heap の定義
 *
 *	@author	myoukaku
 */

#ifndef BKSGE_FND_ALGORITHM_RANGES_SORT_HEAP_HPP
#define BKSGE_FND_ALGORITHM_RANGES_SORT_HEAP_HPP
...
BKSGE_INLINE_VAR BKSGE_CONSTEXPR sort_heap_fn sort_heap{};
...
#endif // BKSGE_FND_ALGORITHM_RANGES_SORT_HEAP_HPP
