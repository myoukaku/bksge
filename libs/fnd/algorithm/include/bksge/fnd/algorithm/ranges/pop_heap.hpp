 ...
 *	@file	pop_heap.hpp
 *
 *	@brief	ranges::pop_heap の定義
 *
 *	@author	myoukaku
 */

#ifndef BKSGE_FND_ALGORITHM_RANGES_POP_HEAP_HPP
#define BKSGE_FND_ALGORITHM_RANGES_POP_HEAP_HPP
...
BKSGE_INLINE_VAR BKSGE_CONSTEXPR pop_heap_fn pop_heap{};
...
#endif // BKSGE_FND_ALGORITHM_RANGES_POP_HEAP_HPP
