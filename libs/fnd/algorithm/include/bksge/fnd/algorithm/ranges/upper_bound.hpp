...
#ifndef BKSGE_FND_ALGORITHM_RANGES_UPPER_BOUND_HPP
#define BKSGE_FND_ALGORITHM_RANGES_UPPER_BOUND_HPP
...
struct upper_bound_fn
{
		...
		T const& value, Comp comp = {}, Proj proj = {}) const
	{
		...
		while (len > 0)
		{
			...
			if (bksge::invoke(comp, value, bksge::invoke(proj, *middle)))
			{
				len = half;
			}
			else
...
BKSGE_INLINE_VAR BKSGE_CONSTEXPR upper_bound_fn upper_bound{};
...
#endif // BKSGE_FND_ALGORITHM_RANGES_UPPER_BOUND_HPP
