...
#ifndef BKSGE_FND_ALGORITHM_RANGES_SET_DIFFERENCE_HPP
#define BKSGE_FND_ALGORITHM_RANGES_SET_DIFFERENCE_HPP
...
struct set_difference_fn
{
	...
	>
#endif
	BKSGE_CXX14_CONSTEXPR set_difference_result<Iter1, Out>
	operator()(
	...
	>
#endif
	BKSGE_CXX14_CONSTEXPR set_difference_result<
		ranges::borrowed_iterator_t<Range1>, Out>
	operator()(
		Range1&& r1, Range2&& r2,
		Out result,
		Comp comp = {},
...
BKSGE_INLINE_VAR BKSGE_CONSTEXPR set_difference_fn set_difference{};
...
#endif // BKSGE_FND_ALGORITHM_RANGES_SET_DIFFERENCE_HPP
