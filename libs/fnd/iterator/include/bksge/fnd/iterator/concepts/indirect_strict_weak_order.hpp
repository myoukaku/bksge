...
private:
	template <typename F2, typename J1, typename J2,
		...
		typename = bksge::enable_if_t<bksge::strict_weak_order<F2&, V1&, V2&>::value>,
		typename = bksge::enable_if_t<bksge::strict_weak_order<F2&, V1&, R2 >::value>,
		typename = bksge::enable_if_t<bksge::strict_weak_order<F2&, R1,  V2&>::value>,
		typename = bksge::enable_if_t<bksge::strict_weak_order<F2&, R1,  R2 >::value>,
		typename = bksge::enable_if_t<bksge::strict_weak_order<F2&, C1,  C2 >::value>
	>
