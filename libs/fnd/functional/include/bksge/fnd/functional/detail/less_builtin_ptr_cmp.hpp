...
template <typename T, typename U>
struct has_operator_less<T, U, bksge::void_t<decltype(operator<(std::declval<T>(), std::declval<U>()))>>
...
template <typename T, typename U>
struct has_member_less<T, U, bksge::void_t<decltype(std::declval<T>().operator<(std::declval<U>()))>>
	: public bksge::true_type {};
