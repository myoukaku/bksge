...
BKSGE_INDIRECTLY_COMPARABLE_TEST(true,  int*, bksge::vector<int>::iterator,       bool(*)(int, int));
BKSGE_INDIRECTLY_COMPARABLE_TEST(true,  int*, bksge::vector<int>::const_iterator, bool(*)(int, int));
