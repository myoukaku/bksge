...
static_assert(bksge::is_same<bksge::iter_rvalue_reference_t<bksge::istreambuf_iterator<T>>, T>::value, "");
static_assert(bksge::is_same<bksge::iter_rvalue_reference_t<bksge::ostreambuf_iterator<T>>, bksge::ostreambuf_iterator<T>&&>::value, "");
