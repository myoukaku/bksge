...
static_assert(bksge::is_same<float,       decltype(bksge::pow(0.0f, 0.0f))>::value, "");
static_assert(bksge::is_same<float,       decltype(bksge::powf(0.0f, 0.0f))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::pow(0.0f, 0.0 ))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::pow(0.0f, 0.0l))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::pow(0.0f, 0   ))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::pow(0.0 , 0.0f))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::pow(0.0 , 0.0 ))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::pow(0.0 , 0.0l))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::pow(0.0 , 0   ))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::pow(0.0l, 0.0f))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::pow(0.0l, 0.0 ))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::pow(0.0l, 0.0l))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::powl(0.0l, 0.0l))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::pow(0.0l, 0   ))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::pow(0   , 0.0f))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::pow(0   , 0.0 ))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::pow(0   , 0.0l))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::pow(0   , 0   ))>::value, "");
