...
static_assert(bksge::is_same<float,       decltype(bksge::sqrt(0.0f))>::value, "");
static_assert(bksge::is_same<float,       decltype(bksge::sqrtf(0.0f))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::sqrt(0.0 ))>::value, "");
static_assert(bksge::is_same<double,      decltype(bksge::sqrt(0   ))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::sqrt(0.0l))>::value, "");
static_assert(bksge::is_same<long double, decltype(bksge::sqrtl(0.0l))>::value, "");
